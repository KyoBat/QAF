...
const taharaQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'La purification rituelle du corps et des vêtements des impuretés', ar: 'التطهر الشرعي للبدن والثياب من النجاسات', en: 'Ritual purification of body and clothes from impurities' } },
      { id: 'c', text: { fr: 'Le lavage des mains avant de manger', ar: 'غسل اليدين قبل الأكل', en: 'Washing hands before eating' } },
      { id: 'd', text: { fr: 'La douche quotidienne', ar: 'الاستحمام اليومي', en: 'Daily shower' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Tahara du Hadath et Tahara de la Najasa', ar: 'طهارة الحدث وطهارة النجاسة', en: 'Tahara from Hadath and Tahara from Najasa' } },
      { id: 'c', text: { fr: 'Tahara obligatoire et Tahara recommandée', ar: 'طهارة واجبة وطهارة مستحبة', en: 'Obligatory Tahara and Recommended Tahara' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'L\'état après avoir uriné', ar: 'الحالة بعد التبول', en: 'State after urinating' } },
      { id: 'b', text: { fr: 'L\'état de Janaba, les menstrues ou les lochies', ar: 'حالة الجنابة أو الحيض أو النفاس', en: 'State of Janaba, menstruation or postpartum bleeding' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'L\'eau pure (Tahur) qui n\'a pas changé de couleur, odeur ou goût', ar: 'الماء الطهور الذي لم يتغير لونه أو ريحه أو طعمه', en: 'Pure water (Tahur) unchanged in color, smell or taste' } },
      { id: 'c', text: { fr: 'L\'eau chaude uniquement', ar: 'الماء الساخن فقط', en: 'Hot water only' } },
      { id: 'd', text: { fr: 'L\'eau de Zamzam uniquement', ar: 'ماء زمزم فقط', en: 'Zamzam water only' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Quand l\'eau est absente ou son usage est nuisible', ar: 'عند فقد الماء أو العجز عن استعماله', en: 'When water is absent or its use is harmful' } },
      { id: 'c', text: { fr: 'Uniquement en voyage', ar: 'في السفر فقط', en: 'Only when traveling' } },
...
const wuduQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: { fr: '4 piliers', ar: '4 أركان', en: '4 pillars' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Dire Bismillah', ar: 'قول بسم الله', en: 'Saying Bismillah' } },
      { id: 'c', text: { fr: 'Essuyer la tête', ar: 'مسح الرأس', en: 'Wiping head' } },
      { id: 'd', text: { fr: 'Laver le visage', ar: 'غسل الوجه', en: 'Washing face' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Jusqu\'aux coudes inclus', ar: 'إلى المرفقين مع إدخالهما', en: 'Up to and including the elbows' } },
      { id: 'c', text: { fr: 'Jusqu\'aux épaules', ar: 'إلى الكتفين', en: 'Up to the shoulders' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Seulement le front', ar: 'الجبهة فقط', en: 'Only the forehead' } },
      { id: 'b', text: { fr: 'Toute la tête avec les oreilles', ar: 'جميع الرأس مع الأذنين', en: 'The entire head including ears' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Ash-hadu an la ilaha illa Allah...', ar: 'أشهد أن لا إله إلا الله...', en: 'Ash-hadu an la ilaha illa Allah...' } },
...
const adhanQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'c', text: { fr: 'Simplement recommandé', ar: 'مستحب فقط', en: 'Simply recommended' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Allahu Akbar Kabira', ar: 'الله أكبر كبيرا', en: 'Allahu Akbar Kabira' } },
      { id: 'b', text: { fr: 'As-salatu khayrun min an-nawm', ar: 'الصلاة خير من النوم', en: 'As-salatu khayrun min an-nawm' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'd', text: { fr: 'Subhan Allah', ar: 'سبحان الله', en: 'Subhan Allah' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const salatQuestions: ExamQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'c', text: { fr: 'Sourate Al-Baqara', ar: 'سورة البقرة', en: 'Surah Al-Baqara' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Subhana Rabbi al-A\'la', ar: 'سبحان ربي الأعلى', en: 'Subhana Rabbi al-A\'la' } },
      { id: 'b', text: { fr: 'Subhana Rabbi al-Adhim', ar: 'سبحان ربي العظيم', en: 'Subhana Rabbi al-Adhim' } },
      { id: 'c', text: { fr: 'Allahu Akbar', ar: 'الله أكبر', en: 'Allahu Akbar' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '2 prosternations', ar: 'سجدتان', en: '2 prostrations' } },
      { id: 'c', text: { fr: '3 prosternations', ar: '3 سجدات', en: '3 prostrations' } },
      { id: 'd', text: { fr: '4 prosternations', ar: '4 سجدات', en: '4 prostrations' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Dire "Allahu Akbar" (Takbirat al-Ihram)', ar: 'قول "الله أكبر" (تكبيرة الإحرام)', en: 'Saying "Allahu Akbar" (Takbirat al-Ihram)' } },
      { id: 'c', text: { fr: 'Réciter du\'a al-istiftah', ar: 'قراءة دعاء الاستفتاح', en: 'Reciting du\'a al-istiftah' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Par le Takbir', ar: 'بالتكبير', en: 'With Takbir' } },
      { id: 'b', text: { fr: 'Par le Taslim (As-salamu alaykum)', ar: 'بالتسليم (السلام عليكم)', en: 'With Taslim (As-salamu alaykum)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Parler volontairement', ar: 'الكلام عمداً', en: 'Speaking deliberately' } },
      { id: 'c', text: { fr: 'Bouger légèrement', ar: 'الحركة الخفيفة', en: 'Slight movement' } },
      { id: 'd', text: { fr: 'Pleurer par crainte d\'Allah', ar: 'البكاء من خشية الله', en: 'Crying from fear of Allah' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const nawafilQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '12 rak\'at', ar: '12 ركعة', en: '12 rak\'at' } },
      { id: 'c', text: { fr: '8 rak\'at', ar: '8 ركعات', en: '8 rak\'at' } },
