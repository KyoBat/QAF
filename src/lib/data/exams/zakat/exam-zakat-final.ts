...
const definitionQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: { fr: 'L\'impôt', ar: 'الضريبة', en: 'Tax' } },
      { id: 'b', text: { fr: 'La purification et l\'accroissement', ar: 'التطهير والنماء', en: 'Purification and growth' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Obligatoire - 3ème pilier de l\'Islam', ar: 'فرض - الركن الثالث من أركان الإسلام', en: 'Obligatory - 3rd pillar of Islam' } },
      { id: 'c', text: { fr: 'Recommandée', ar: 'مستحبة', en: 'Recommended' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Son argent sera transformé en serpent le Jour du Jugement', ar: 'يُحول ماله إلى ثعبان يوم القيامة', en: 'His money will become a serpent on Judgment Day' } },
      { id: 'c', text: { fr: 'Il doit faire des bonnes actions supplémentaires', ar: 'عليه أعمال صالحة إضافية', en: 'He must do extra good deeds' } },
      { id: 'd', text: { fr: 'Il n\'y a pas de conséquence', ar: 'لا عقوبة', en: 'There is no consequence' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const conditionsQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Islam, liberté, possession du Nisab, passage d\'une année lunaire (Hawl)', ar: 'الإسلام، الحرية، ملك النصاب، مرور الحول', en: 'Islam, freedom, owning Nisab, passage of lunar year (Hawl)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Le seuil minimum de richesse rendant la Zakat obligatoire', ar: 'الحد الأدنى من المال الذي تجب فيه الزكاة', en: 'The minimum threshold of wealth making Zakat obligatory' } },
      { id: 'c', text: { fr: 'La date de paiement', ar: 'تاريخ الدفع', en: 'The payment date' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'L\'écoulement d\'une année lunaire complète sur la possession du Nisab', ar: 'مرور سنة قمرية كاملة على ملك النصاب', en: 'The passage of a complete lunar year on owning the Nisab' } },
      { id: 'c', text: { fr: 'Le montant total à payer', ar: 'المبلغ الإجمالي للدفع', en: 'The total amount to pay' } },
      { id: 'd', text: { fr: 'La bénédiction sur les biens', ar: 'البركة في المال', en: 'The blessing on wealth' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Oui, le tuteur doit la payer en leur nom (avis majoritaire)', ar: 'نعم، يُخرجها الولي عنهم (قول الجمهور)', en: 'Yes, the guardian must pay on their behalf (majority view)' } },
...
const biensQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Or, argent, argent liquide, marchandises commerciales', ar: 'الذهب، الفضة، النقود، عروض التجارة', en: 'Gold, silver, cash, trade goods' } },
      { id: 'c', text: { fr: 'La maison d\'habitation', ar: 'بيت السكن', en: 'The residence' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '85 grammes (20 Mithqal)', ar: '85 غرام (20 مثقالاً)', en: '85 grams (20 Mithqal)' } },
      { id: 'c', text: { fr: '100 grammes', ar: '100 غرام', en: '100 grams' } },
      { id: 'd', text: { fr: '1 kilogramme', ar: '1 كيلوغرام', en: '1 kilogram' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: '100 grammes', ar: '100 غرام', en: '100 grams' } },
      { id: 'b', text: { fr: '595 grammes (200 Dirhams)', ar: '595 غرام (200 درهم)', en: '595 grams (200 Dirhams)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '2.5% (un quart du dixième)', ar: '2.5% (ربع العشر)', en: '2.5% (one quarter of one tenth)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Sur la valeur marchande actuelle à la fin de l\'année', ar: 'على القيمة السوقية الحالية عند حولان الحول', en: 'On current market value at the end of the year' } },
      { id: 'c', text: { fr: 'Sur le profit uniquement', ar: 'على الربح فقط', en: 'On profit only' } },
      { id: 'd', text: { fr: 'On ne paie pas de Zakat sur le commerce', ar: 'لا زكاة في التجارة', en: 'No Zakat on trade' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const beneficiairesQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: { fr: '5 catégories', ar: '5 أصناف', en: '5 categories' } },
      { id: 'b', text: { fr: '8 catégories', ar: '8 أصناف', en: '8 categories' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Le Faqir n\'a rien, le Miskin a quelque chose mais insuffisant', ar: 'الفقير لا يملك شيئًا، والمسكين يملك شيئًا لا يكفيه', en: 'Faqir has nothing, Miskin has something but insufficient' } },
      { id: 'c', text: { fr: 'Le Miskin est un voyageur', ar: 'المسكين هو المسافر', en: 'Miskin is a traveler' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Ceux dont on veut gagner les cœurs à l\'Islam ou les affermir', ar: 'من يُراد تأليف قلوبهم للإسلام أو تثبيتهم', en: 'Those whose hearts are to be reconciled to Islam or strengthened' } },
      { id: 'c', text: { fr: 'Les orphelins', ar: 'الأيتام', en: 'Orphans' } },
      { id: 'd', text: { fr: 'Les femmes veuves', ar: 'الأرامل', en: 'Widows' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Toute bonne œuvre', ar: 'كل عمل خير', en: 'Any good deed' } },
      { id: 'b', text: { fr: 'Principalement le Jihad et la défense de l\'Islam (avis classique)', ar: 'أساسًا الجهاد والدفاع عن الإسلام (القول التقليدي)', en: 'Mainly Jihad and defense of Islam (classical view)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Non, car on a l\'obligation de les entretenir (Nafaqa)', ar: 'لا، لأن نفقتهم واجبة', en: 'No, because one is obligated to support them (Nafaqa)' } },
      { id: 'c', text: { fr: 'Seulement les parents', ar: 'الوالدين فقط', en: 'Only parents' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Un voyageur à court de moyens, même s\'il est riche dans son pays', ar: 'مسافر انقطعت به السُّبُل، حتى لو كان غنيًا في بلده', en: 'A stranded traveler, even if rich in his homeland' } },
      { id: 'c', text: { fr: 'Un commerçant', ar: 'تاجر', en: 'A merchant' } },
      { id: 'd', text: { fr: 'Un étudiant', ar: 'طالب', en: 'A student' } },
    ],
    correctAnswer: 1,
    explanation: {
