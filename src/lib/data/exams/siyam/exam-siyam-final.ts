...
const definitionQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'S\'abstenir de manger, boire et rapports intimes du Fajr au Maghrib avec intention', ar: 'الإمساك عن الأكل والشرب والجماع من الفجر إلى المغرب مع النية', en: 'Abstaining from eating, drinking and intimacy from Fajr to Maghrib with intention' } },
      ...
      { id: 'd', text: { fr: 'Jeûner les jours pairs du mois', ar: 'صيام الأيام الزوجية من الشهر', en: 'Fasting even days of the month' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Obligatoire (Fard)', ar: 'فرض', en: 'Obligatory (Fard)' } },
      { id: 'c', text: { fr: 'Recommandé', ar: 'مستحب', en: 'Recommended' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'La 1ère année de l\'Hégire', ar: 'السنة الأولى للهجرة', en: 'The 1st year of Hijra' } },
      { id: 'b', text: { fr: 'La 2ème année de l\'Hégire', ar: 'السنة الثانية للهجرة', en: 'The 2nd year of Hijra' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Par la vision du croissant ou en complétant Cha\'ban à 30 jours', ar: 'برؤية الهلال أو بإكمال شعبان ثلاثين يومًا', en: 'By sighting the crescent or completing Sha\'ban to 30 days' } },
      { id: 'c', text: { fr: 'Par les calculs astronomiques uniquement', ar: 'بالحسابات الفلكية فقط', en: 'By astronomical calculations only' } },
      { id: 'd', text: { fr: 'À une date fixe chaque année', ar: 'في تاريخ ثابت كل عام', en: 'On a fixed date every year' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const conditionsQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Islam, puberté, raison, capacité', ar: 'الإسلام، البلوغ، العقل، القدرة', en: 'Islam, puberty, sanity, ability' } },
      { id: 'c', text: { fr: 'Être âgé de plus de 40 ans', ar: 'أن يكون عمره فوق 40 سنة', en: 'Being over 40 years old' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Manger le Suhur et prier Tarawih', ar: 'أكل السحور وصلاة التراويح', en: 'Eating Suhur and praying Tarawih' } },
      { id: 'b', text: { fr: 'L\'intention et l\'abstention des annulatifs du Fajr au Maghrib', ar: 'النية والإمساك عن المفطرات من الفجر إلى المغرب', en: 'Intention and abstaining from invalidators from Fajr to Maghrib' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Non, mais il est recommandé de l\'habituer', ar: 'لا، لكن يُستحب تعويده', en: 'No, but it is recommended to accustom him' } },
      { id: 'c', text: { fr: 'Il est interdit de le faire jeûner', ar: 'يحرم تصويمه', en: 'It is forbidden to make him fast' } },
      { id: 'd', text: { fr: 'Seulement les 10 premiers jours', ar: 'فقط العشرة الأيام الأولى', en: 'Only the first 10 days' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'De l\'aube vraie (Fajr Sadiq) au coucher du soleil', ar: 'من الفجر الصادق إلى غروب الشمس', en: 'From true dawn (Fajr Sadiq) to sunset' } },
      { id: 'c', text: { fr: 'De minuit à midi', ar: 'من منتصف الليل إلى الظهر', en: 'From midnight to noon' } },
...
const annulatifsQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Se brosser les dents avec du Siwak', ar: 'استخدام السواك', en: 'Brushing teeth with Siwak' } },
      { id: 'b', text: { fr: 'Manger ou boire volontairement', ar: 'الأكل أو الشرب عمدًا', en: 'Eating or drinking deliberately' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Son jeûne est valide, il continue normalement', ar: 'صومه صحيح ويستمر', en: 'His fast is valid, he continues normally' } },
      { id: 'c', text: { fr: 'Il doit payer une Kaffara', ar: 'عليه كفارة', en: 'He must pay Kaffara' } },
      { id: 'd', text: { fr: 'Il doit recommencer le mois entier', ar: 'يجب أن يُعيد الشهر كله', en: 'He must restart the entire month' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Le rattrapage ET la Kaffara (expiation)', ar: 'القضاء والكفارة', en: 'Making up AND Kaffara (expiation)' } },
      { id: 'c', text: { fr: 'Rien, c\'est permis', ar: 'لا شيء، فهو جائز', en: 'Nothing, it is permissible' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Oui, il annule le jeûne', ar: 'نعم، يُبطل الصيام', en: 'Yes, it invalidates fasting' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Les nutritives annulent, les médicinales non nutritives sont tolérées', ar: 'المغذية تُبطل، والدوائية غير المغذية لا تُبطل', en: 'Nutritive ones invalidate, non-nutritive medicinal ones are tolerated' } },
      { id: 'c', text: { fr: 'N\'annulent jamais le jeûne', ar: 'لا تُبطل الصيام أبدًا', en: 'Never invalidate fasting' } },
      { id: 'd', text: { fr: 'Annulent seulement si faites avant Dhuhr', ar: 'تُبطل فقط إذا كانت قبل الظهر', en: 'Invalidate only if done before Dhuhr' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Manger, boire volontairement, vomissement volontaire', ar: 'الأكل والشرب عمدًا، والقيء العمد', en: 'Eating, drinking deliberately, deliberate vomiting' } },
      { id: 'c', text: { fr: 'Dormir toute la journée', ar: 'النوم طوال اليوم', en: 'Sleeping all day' } },
...
const dispensesQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Les étudiants pendant les examens', ar: 'الطلاب أثناء الامتحانات', en: 'Students during exams' } },
      { id: 'b', text: { fr: 'Le voyageur, le malade, la femme enceinte/allaitante, le vieillard incapable', ar: 'المسافر، المريض، الحامل والمرضع، الشيخ الكبير العاجز', en: 'The traveler, the sick, pregnant/nursing woman, the incapable elderly' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Il lui est interdit de jeûner et elle rattrape après Ramadan', ar: 'يحرم عليها الصيام وتقضي بعد رمضان', en: 'Fasting is forbidden and she makes up after Ramadan' } },
      { id: 'c', text: { fr: 'Elle peut choisir de jeûner ou non', ar: 'لها الخيار أن تصوم أو لا', en: 'She can choose to fast or not' } },
      { id: 'd', text: { fr: 'Elle paie la Fidya seulement', ar: 'تدفع الفدية فقط', en: 'She pays Fidya only' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Nourrir un pauvre pour chaque jour non jeûné', ar: 'إطعام مسكين عن كل يوم أُفطر', en: 'Feeding a poor person for each day not fasted' } },
      { id: 'c', text: { fr: 'Une somme d\'argent fixe', ar: 'مبلغ مالي ثابت', en: 'A fixed sum of money' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Jeûner obligatoirement', ar: 'تصوم وجوبًا', en: 'Fast obligatorily' } },
      { id: 'b', text: { fr: 'Rompre et rattraper plus tard (certains ajoutent la Fidya)', ar: 'تُفطر وتقضي لاحقًا (وبعضهم يوجب الفدية أيضًا)', en: 'Break fast and make up later (some add Fidya)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Avant le Ramadan suivant', ar: 'قبل رمضان التالي', en: 'Before the next Ramadan' } },
      { id: 'c', text: { fr: 'Dans les 5 ans', ar: 'خلال 5 سنوات', en: 'Within 5 years' } },
      { id: 'd', text: { fr: 'N\'importe quand dans sa vie', ar: 'في أي وقت من حياته', en: 'Anytime in one\'s life' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const naflQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Les lundis et jeudis, les jours blancs (13, 14, 15)', ar: 'الاثنين والخميس، والأيام البيض (13، 14، 15)', en: 'Mondays and Thursdays, the white days (13, 14, 15)' } },
      { id: 'c', text: { fr: 'Le premier jour de chaque mois', ar: 'أول يوم من كل شهر', en: 'The first day of each month' } },
