...
const avantProphetieQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      { id: 'a', text: { fr: '550 après J.-C.', ar: '550 م', en: '550 CE' } },
      { id: 'b', text: { fr: '570 après J.-C. (Année de l\'Éléphant)', ar: '570 م (عام الفيل)', en: '570 CE (Year of the Elephant)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'c', text: { fr: 'Umm Ayman', ar: 'أم أيمن', en: 'Umm Ayman' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'As-Sadiq al-Amin (Le Véridique, le Digne de confiance)', ar: 'الصادق الأمين', en: 'As-Sadiq al-Amin (The Truthful, the Trustworthy)' } },
      { id: 'c', text: { fr: 'Le Riche', ar: 'الغني', en: 'The Rich' } },
      { id: 'd', text: { fr: 'Le Poète', ar: 'الشاعر', en: 'The Poet' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: '20 ans', ar: '20 سنة', en: '20 years' } },
      { id: 'b', text: { fr: '25 ans', ar: '25 سنة', en: '25 years' } },
...
const periodeMecquoiseQuestions: ExamQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '"Lis ! Au nom de ton Seigneur qui a créé..." (Al-\'Alaq 1-5)', ar: '"اقرأ باسم ربك الذي خلق..." (العلق 1-5)', en: '"Read! In the name of your Lord who created..." (Al-\'Alaq 1-5)' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '13 ans', ar: '13 سنة', en: '13 years' } },
      { id: 'c', text: { fr: '10 ans', ar: '10 سنوات', en: '10 years' } },
      { id: 'd', text: { fr: '23 ans', ar: '23 سنة', en: '23 years' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Deux batailles', ar: 'معركتان', en: 'Two battles' } },
      { id: 'b', text: { fr: 'Le voyage nocturne à Jérusalem et l\'ascension aux cieux', ar: 'رحلة ليلية إلى القدس ثم الصعود إلى السماوات', en: 'The night journey to Jerusalem and ascension to the heavens' } },
...
const periodeMedinoiseQuestions: ExamQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Un accord établissant les droits et devoirs entre musulmans, juifs et autres tribus', ar: 'اتفاق يحدد حقوق وواجبات المسلمين واليهود والقبائل الأخرى', en: 'An agreement establishing rights and duties between Muslims, Jews and other tribes' } },
      { id: 'c', text: { fr: 'Une lettre au roi de Perse', ar: 'رسالة لكسرى', en: 'A letter to the Persian king' } },
      { id: 'd', text: { fr: 'Le traité de Hudaybiyya', ar: 'صلح الحديبية', en: 'Treaty of Hudaybiyya' } },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Un système d\'impôt', ar: 'نظام ضرائب', en: 'A tax system' } },
      { id: 'b', text: { fr: 'Le Prophète ﷺ a jumelé chaque Muhajir avec un Ansar comme frères', ar: 'جعل النبي ﷺ لكل مهاجر أخًا من الأنصار', en: 'The Prophet ﷺ paired each Muhajir with an Ansar as brothers' } },
...
const bataillesQuestions: ExamQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Victoire initiale puis revers à cause de la désobéissance des archers', ar: 'نصر أولي ثم نكسة بسبب عصيان الرماة', en: 'Initial victory then setback due to archers\' disobedience' } },
      { id: 'c', text: { fr: 'Aucune bataille n\'a eu lieu', ar: 'لم تقع معركة', en: 'No battle occurred' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'c', text: { fr: '\'Umar', ar: 'عمر', en: '\'Umar' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'An 6 de l\'Hégire', ar: 'السنة 6 هـ', en: 'Year 6 H' } },
      { id: 'b', text: { fr: 'An 8 de l\'Hégire', ar: 'السنة 8 هـ', en: 'Year 8 H' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'Un accord de paix de 10 ans avec Quraysh (6 H)', ar: 'اتفاق سلام 10 سنوات مع قريش (6 هـ)', en: 'A 10-year peace agreement with Quraysh (6 H)' } },
...
const dernieresAnneesQuestions: ExamQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: 'Al-Fatiha', ar: 'الفاتحة', en: 'Al-Fatiha' } },
      { id: 'b', text: { fr: '"Aujourd\'hui J\'ai parachevé votre religion..." (5:3)', ar: '"اليوم أكملت لكم دينكم..." (المائدة: 3)', en: '"Today I have perfected your religion..." (5:3)' } },
      { id: 'c', text: { fr: 'Ayat al-Kursi', ar: 'آية الكرسي', en: 'Ayat al-Kursi' } },
      { id: 'd', text: { fr: 'Les premiers versets révélés', ar: 'أول ما نزل', en: 'The first revealed verses' } },
    ],
    correctAnswer: 1,
    explanation: {
...
const familleQuestions: ExamQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: '7 enfants (3 garçons, 4 filles)', ar: '7 أبناء (3 ذكور، 4 إناث)', en: '7 children (3 boys, 4 girls)' } },
      { id: 'c', text: { fr: '10 enfants', ar: '10 أبناء', en: '10 children' } },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: { fr: '\'Aisha bint Abi Bakr', ar: 'عائشة بنت أبي بكر', en: '\'Aisha bint Abi Bakr' } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: { fr: 'La famille du Prophète ﷺ : ses épouses et sa descendance', ar: 'عائلة النبي ﷺ: زوجاته وذريته', en: 'The Prophet\'s ﷺ family: his wives and descendants' } },
      { id: 'c', text: { fr: 'Les habitants de Médine', ar: 'سكان المدينة', en: 'The inhabitants of Medina' } },
      { id: 'd', text: { fr: 'Les Quraysh', ar: 'قريش', en: 'The Quraysh' } },
    ],
    correctAnswer: 1,
    explanation: {
