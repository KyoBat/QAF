...
| ⬇️ Position | Arabe | Rôle | Exemple |
|------------|-------|------|--------|
| **1** | المصنف (Musannif) | Le compilateur | Al-Bukhari |
| **2** | الشيخ (Shaykh) | Son maître | |
| **3** | ... | Autres narrateurs | |
| **4** | التابعي (Tabi'i) | Le Successeur | |
| **5** | الصحابي (Sahabi) | Le Compagnon | |
| **6** | النبي ﷺ | Le Prophète ﷺ | |
