/**
 * Mustalah al-Hadith - Lesson 003: السند والإسناد
 * The Chain of Transmission (Isnad)
 * English Content
 */

export const content = `# 📜 السند والإسناد — The Chain of Transmission
...
|------|--------|------------|
| **Mutawatir** | مُتَوَاتِر | So many narrators they couldn't have lied | Absolute certainty |
| **Ahad** | آحَاد | Less than Mutawatir | Can be Sahih, Hasan, or Da'if |
...
1. **Analyze** a chain from Riyad as-Salihin
2. **Identify**: Who is the Sahabi? Who is the Tabi'i?
3. **Research** a narrator's biography on Islamweb
