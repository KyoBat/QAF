/**
 * Family Fiqh - Lesson 002: Engagement (Khitbah)
 * English content - Immersive version
 */

export const contentEn = `# 💍 Al-Khitbah — The Islamic Engagement
...
| Term | Definition |
|------|------------|
| **Khitbah** | A man's request to marry a specific woman |
| **Khatib** | The one proposing |
| **Makhtuba** | The woman being proposed to |
...
| Situation | Ruling |
|-----------|--------|
| ⚪ In general | Permissible (Mubah) |
| 🟢 If needed to avoid haram | May become recommended |
| 🔴 Proposing to one already proposed to | Prohibited |
...
| Situation | Ruling |
|-----------|--------|
| 🟢 With intention of marriage | Permissible |
| 🔴 Without intention | Not permissible |

### What Can Be Seen?

| Opinion | What Is Permitted |
|---------|-------------------|
| 🔵 Majority | Face and hands |
| 🟢 Some Hanbalis | What normally appears (face, hands, feet) |
| 📜 All agree | Must be with serious intention |
...
| Condition | Meaning |
|-----------|---------|
| 🔓 Free from impediments | Not currently married |
| ⏳ Not in 'iddah | Except certain cases |
| 💔 Not proposed to already | Cannot propose over another's proposal |

### Regarding 'Iddah

| Type of 'Iddah | Explicit Proposal | Implicit Indication |
|----------------|-------------------|---------------------|
...
| Situation | Ruling |
|-----------|--------|
| ⚪ Breaking engagement | Permissible (makruh without reason) |
| 💍 Gifts given | Must be returned if requested |
| 💰 Mahr paid early | Must be returned |

### The Gifts Issue

| Type of Gift | Ruling |
|--------------|--------|
| 🎁 Conditional on marriage | Must be returned |
| 🎁 Pure gift | According to custom |
...
| Mistake | Correction |
|---------|------------|
| 📱 Online "getting to know" first | Involve families from the start |
| 💬 Long private conversations | Keep communication limited and purposeful |
| 🚗 Going out alone | Always with mahram |
| 💑 Acting like a couple | Remember: still strangers |
| ⏰ Extended engagements | Keep it reasonably short |
...
| Step | Action |
|------|--------|
| 1️⃣ | Minimal initial conversation (basic compatibility) |
| 2️⃣ | Involve families immediately |
| 3️⃣ | Official meeting with mahram present |
| 4️⃣ | If interested, proceed to khitbah |
...
| Situation | Ruling |
|-----------|--------|
| 🟢 Valid concern | She has every right to withdraw |
| 💍 Return gifts | What was conditional on marriage |
| 💰 Mahr | Returns if already paid |
...
| Issue | Problem |
|-------|---------|
| ⚠️ Prolonged temptation | They're still strangers |
| ⚠️ Acting like married | May fall into haram |
| ⚠️ Community perception | People assume they're married |
...
| Situation | Ruling |
|-----------|--------|
| 🔴 She accepted the first | Cannot propose |
| 🟢 First was rejected | May propose |
| 🟡 Still considering first | Wait for her decision |
...
| View | Position |
|------|----------|
| 🟢 Some scholars | Photo is sufficient to decide |
| 🟡 Better approach | Meet in person after initial interest |
| 📜 The wisdom | Seeing in person is more accurate |
...
| Concept | Explanation |
|---------|-------------|
| 🎯 Definition | A man's request to marry a specific woman |
| ⚖️ Ruling | Permissible, may become recommended |
| 👀 Looking | Permitted with intention of marriage |
| 📜 Conditions | She must be free, not in 'iddah, not proposed to |
| 🤝 Behavior | She remains a stranger until marriage |
| 💔 Breaking | Permissible, gifts usually returned |
`;
