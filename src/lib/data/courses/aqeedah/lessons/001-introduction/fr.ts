...
Ce n'est pas simplement des informations à mémoriser, mais une **certitude qui habite ton cœur** et se traduit dans ta vie.
...
Les cinq prières n'ont été rendues obligatoires que la dernière année. La zakat, le jeûne et le hajj n'ont été prescrits qu'à Médine.

**13 années entières pour construire la 'aqeedah dans les cœurs.**
...
> "Quiconque, homme ou femme, fait une bonne œuvre tout en étant croyant, ceux-là entreront au Paradis." (An-Nisa 4:124)

Remarque la condition : **"tout en étant croyant"**

L'œuvre pieuse sans foi correcte = poussière dispersée.
...
- Pourquoi suis-je ici ? ← **Pour adorer Allah**
- Où vais-je ? ← **Vers Allah, puis le Paradis ou l'Enfer**
...
> "Allah affermit les croyants par une parole ferme, dans la vie présente et dans l'au-delà." (Ibrahim 14:27)
...
3. 📖 **Foi aux Livres** — Le Coran et les livres précédents → *Leçon 6*
4. 🕌 **Foi aux Messagers** — D'Adam à Muhammad ﷺ → *Leçon 7*
5. ⚖️ **Foi au Jour Dernier** — Résurrection, Jugement, Paradis et Enfer → *Leçon 8*
6. 📜 **Foi au Destin** — Science d'Allah, écriture, volonté et création → *Leçon 9*
...
> "Le Messager a cru en ce qui lui a été révélé de la part de son Seigneur, ainsi que les croyants. Tous ont cru en Allah, en Ses anges, en Ses livres et en Ses messagers. Nous ne faisons aucune distinction entre Ses messagers." (Al-Baqara 2:285)
...
> "La bonté pieuse n'est pas que vous tourniez vos visages vers l'Orient et l'Occident. Mais la bonté pieuse est de croire en Allah, au Jour Dernier, aux Anges, au Livre et aux prophètes." (Al-Baqara 2:177)
...
Pharaon connaissait la vérité :
> ﴿قَالَ لَقَدْ عَلِمْتَ مَا أَنزَلَ هَٰؤُلَاءِ إِلَّا رَبُّ السَّمَاوَاتِ وَالْأَرْضِ بَصَائِرَ﴾
> "Il dit : 'Tu sais bien que c'est le Seigneur des cieux et de la terre qui a fait descendre ces miracles comme preuves évidentes.'" (Al-Isra 17:102)
...
- **Le cœur** : croit, aime, craint et espère
- **La langue** : prononce les deux témoignages et évoque Allah
- **Les membres** : agissent selon ce qui plaît à Allah

---

## Notre voyage dans ce cours

Nous naviguerons ensemble dans les profondeurs de ces six piliers :

1. **Le Tawhid** sous ses trois formes (Rububiyyah, Uluhiyyah, Asma wa Sifat)
2. Le monde fascinant des **Anges**
3. Les **Livres célestes** dont le Coran est le sceau
4. Les récits des **Prophètes** et leurs enseignements
5. Les événements extraordinaires du **Jour Dernier**
6. La sagesse du **Destin** et ses secrets

Chaque leçon est fondée sur les preuves du **Coran et de la Sunnah authentique uniquement**.

---

## 🛡️ Réfutation des Doutes (الشُّبُهات والرد عليها)

### Premier doute : "La Aqeedah divise les musulmans"

**❌ Le doute :** Certains disent : "Pourquoi étudier la Aqeedah ? Cela divise la Oumma et crée des conflits !"

**✅ La réfutation :**

1. **La Aqeedah correcte unifie, elle ne divise pas :**
   > ﴿وَاعْتَصِمُوا بِحَبْلِ اللَّهِ جَمِيعًا وَلَا تَفَرَّقُوا﴾
   > "Et cramponnez-vous tous ensemble au câble d'Allah et ne soyez pas divisés." [Âl-'Imrân : 103]
   
   Le câble d'Allah est Sa religion et Sa Aqeedah correcte.

2. **La division vient de l'abandon de la Aqeedah correcte :**
   L'Imam Malik رحمه الله a dit : *"Rien ne réformera la fin de cette communauté si ce n'est ce qui a réformé son début."*

3. **Les Compagnons se sont unis sur une seule Aqeedah** et furent la meilleure génération.

---

### Deuxième doute : "Il suffit d'être une bonne personne"

**❌ Le doute :** "L'important c'est d'avoir bon cœur, pas besoin d'étudier la Aqeedah !"

**✅ La réfutation :**

1. **Les œuvres sans Aqeedah correcte ne sont pas acceptées :**
   > ﴿وَقَدِمْنَا إِلَىٰ مَا عَمِلُوا مِنْ عَمَلٍ فَجَعَلْنَاهُ هَبَاءً مَّنثُورًا﴾
   > "Nous avons considéré les œuvres qu'ils ont accomplies et Nous en avons fait de la poussière éparpillée." [Al-Furqân : 23]

2. **Hadith du Prophète ﷺ :**
   > « مَنْ عَمِلَ عَمَلًا لَيْسَ عَلَيْهِ أَمْرُنَا فَهُوَ رَدٌّ »
   > "Quiconque accomplit une œuvre non conforme à notre ordre, elle sera rejetée." (Sahih Muslim 1718)

3. **Exemple :** Abou Talib, l'oncle du Prophète ﷺ, le défendait et le protégeait, mais il mourut sur le polythéisme et cela ne lui a pas profité.

---

### Troisième doute : "Les sciences profanes sont plus importantes à notre époque"

**❌ Le doute :** "Nous sommes à l'ère de la technologie, les sciences profanes sont prioritaires !"

**✅ La réfutation :**

1. **La science du monde est utile mais ne suffit pas :**
   > ﴿يَعْلَمُونَ ظَاهِرًا مِّنَ الْحَيَاةِ الدُّنْيَا وَهُمْ عَنِ الْآخِرَةِ هُمْ غَافِلُونَ﴾
   > "Ils connaissent un aspect apparent de la vie présente, tandis que de l'au-delà ils sont insouciants." [Ar-Rûm : 7]

2. **Qârûn** était le plus riche et le plus savant en chimie :
   > ﴿فَخَسَفْنَا بِهِ وَبِدَارِهِ الْأَرْضَ﴾
   > "Nous fîmes donc qu'il s'engloutît dans la terre, ainsi que sa maison." [Al-Qasas : 81]

3. **Combiner les deux sciences est possible** et l'Islam l'encourage.

---

### Quatrième doute : "Je ne peux pas comprendre l'invisible"

**❌ Le doute :** "Comment croire en ce que je ne vois pas ? Les anges, le Paradis, l'Enfer..."

**✅ La réfutation :**

1. **L'invisible est le signe de la vraie foi :**
   > ﴿الَّذِينَ يُؤْمِنُونَ بِالْغَيْبِ﴾
   > "Ceux qui croient à l'invisible." [Al-Baqarah : 3]

2. **Tu crois en des choses invisibles chaque jour :**
   - As-tu vu ton cerveau ? Pourtant tu crois en son existence.
   - As-tu vu l'électricité ? Pourtant tu y crois.
   - As-tu vu tes ancêtres lointains ? Pourtant tu crois en leur existence.

3. **Allah nous a informé de l'invisible** et Il est le Véridique :
   > ﴿وَمَنْ أَصْدَقُ مِنَ اللَّهِ حَدِيثًا﴾
   > "Et qui est plus véridique qu'Allah en parole ?" [An-Nisâ' : 87]

---

## 📜 Récits et Traditions des Pieux Prédécesseurs
...
## 💎 Paroles des Savants sur l'Importance de la Aqeedah

### L'Imam Abou Hanifa رحمه الله (150H)

> **"La compréhension du Deen est meilleure que la compréhension des règles juridiques, et qu'un homme comprenne comment adorer son Seigneur est meilleur pour lui que d'accumuler beaucoup de science."**

---

### L'Imam Ash-Shafi'i رحمه الله (204H)
...
### L'Imam Ahmad ibn Hanbal رحمه الله (241H)

On lui demanda : Qu'est-ce que la science ?

Il répondit : **"La science : Lâ ilâha illa Allah."**

---

### L'Imam Ibn Al-Qayyim رحمه الله (751H)

> **"Dans le cœur il y a un déchirement que seul le retour vers Allah peut réparer, une solitude que seul l'intimité avec Lui peut dissiper, une tristesse que seule la joie de Le connaître et de Le traiter sincèrement peut ôter, et une anxiété que seule la fuite vers Lui peut apaiser."**

---

### Cheikh Muhammad ibn 'Abd al-Wahhab رحمه الله (1206H)

> **"Sache que le Tawheed consiste à vouer l'adoration à Allah seul, et c'est la religion de tous les Messagers qu'Allah a envoyés à Ses serviteurs."**

---

### Cheikh Ibn Baz رحمه الله (1420H)

> **"La Aqeedah correcte est le fondement sur lequel la religion est bâtie, et l'œuvre pieuse n'est acceptée qu'avec elle. Le musulman doit donc lui accorder le plus grand soin."**

---

## 📿 Hadiths sur le Mérite de la Science de la Aqeedah

### Hadith de Mu'awiya رضي الله عنه

Le Messager d'Allah ﷺ a dit :

> **« مَنْ يُرِدِ اللَّهُ بِهِ خَيْرًا يُفَقِّهْهُ فِي الدِّينِ »**
> "Celui à qui Allah veut du bien, Il lui accorde la compréhension de la religion." (Sahih al-Bukhari 71, Sahih Muslim 1037)

La compréhension de la religion commence par la Aqeedah avant tout.

---

### Hadith d'Abou Hourayra رضي الله عنه
...
> "La foi comporte soixante-dix et quelques branches, la plus élevée est la parole Lâ ilâha illa Allah, et la plus basse est d'écarter un obstacle du chemin." (Sahih Muslim 35)

La branche la plus élevée de la foi : **la parole du Tawheed** — qui est le fondement de la Aqeedah.

---

### Hadith de 'Itban ibn Malik رضي الله عنه

Le Messager d'Allah ﷺ a dit :

> **« إِنَّ اللَّهَ حَرَّمَ عَلَى النَّارِ مَنْ قَالَ: لاَ إِلَهَ إِلاَّ اللَّهُ، يَبْتَغِي بِذَلِكَ وَجْهَ اللَّهِ »**
> "Certes Allah a interdit à l'Enfer quiconque dit Lâ ilâha illa Allah, recherchant par cela le Visage d'Allah." (Sahih al-Bukhari 415, Sahih Muslim 33)
