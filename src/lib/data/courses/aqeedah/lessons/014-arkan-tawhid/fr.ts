...
> "Certes Allah ne pardonne pas qu'on Lui donne des associés. À part cela, Il pardonne à qui Il veut." (An-Nisa 4:48)
...
## Troisième Catégorie: Tawhid Al-Asma was-Sifat (Unicité des Noms et Attributs)

### Définition

Vouer exclusivement à Allah Ses plus beaux Noms et Ses Attributs suprêmes, en affirmant ce qu'Il a affirmé pour Lui-même ou ce que Son Messager ﷺ a affirmé pour Lui, et en niant ce qu'Il a nié de Lui-même.
...
### Règles du Tawhid des Noms et Attributs

#### Première règle: Affirmation sans ressemblance

Nous affirmons les Attributs tels qu'ils sont venus, sans les comparer aux créatures.

> "Il n'y a rien qui Lui ressemble." (Ash-Shura 42:11)

#### Deuxième règle: Transcendance sans négation

Nous transcendons Allah au-dessus des défauts, mais nous ne nions pas Ses Attributs.

> "Et c'est Lui l'Audient, le Clairvoyant." (Ash-Shura 42:11)

#### Troisième règle: Ne pas s'aventurer dans le "comment"

Nous affirmons l'Attribut sans demander sa modalité.
...
#### Quatrième règle: S'en tenir au texte

Nous n'affirmons pour Allah que ce qu'Il a affirmé pour Lui-même, et ne nions que ce qu'Il a nié.

---

## La Relation entre les Trois Catégories du Tawhid

### L'interdépendance entre elles

1. **Le Tawhid Ar-Rububiyyah implique le Tawhid Al-Uluhiyyah:**
   Celui qui reconnaît qu'Allah est le Créateur et le Pourvoyeur doit L'adorer Lui seul.

2. **Le Tawhid Al-Uluhiyyah contient le Tawhid Ar-Rububiyyah:**
   Celui qui adore Allah seul a reconnu Sa Seigneurie.

3. **Le Tawhid des Noms et Attributs est la base des deux:**
   Connaître les Noms et Attributs d'Allah nécessite de L'aimer, de Le craindre et de L'adorer.

### Manquer à une catégorie, c'est manquer au Tawhid

| Manquement | Résultat |
|------------|----------|
| Nier la Seigneurie | Mécréance explicite (athéisme) |
| Shirk dans l'adoration | Shirk majeur (adorer autre qu'Allah) |
| Déformer les Noms et Attributs | Innovation pouvant mener à la mécréance |
...
> **"Le Tawhid pour lequel Allah a envoyé les Messagers est le Tawhid de l'adoration, qui contient le Tawhid de la Seigneurie."**

---

### Imam Ibn al-Qayyim رحمه الله

> **"Le Tawhid est le premier appel des Messagers, la première station du chemin, et le premier rang où se tient le cheminant vers Allah."**

---

### Shaykh Muhammad ibn Abdel-Wahhab رحمه الله

> **"Sache que le Tawhid est de vouer l'adoration à Allah seul, et c'est la religion de tous les Messagers."**

---

### Shaykh Ibn Baz رحمه الله

> **"Les catégories du Tawhid sont au nombre de trois, et elles sont tirées de l'induction des textes du Livre et de la Sunna."**

---

## Les Fruits du Tawhid

1. **Le salut du Feu**: ﴿Quiconque associe à Allah, Allah lui interdit le Paradis﴾
2. **L'entrée au Paradis**: «Quiconque meurt sans rien associer à Allah entre au Paradis» (Sahih Bukhari)
3. **La sécurité et la guidée**: ﴿Ceux qui ont cru et n'ont pas obscurci leur foi par une injustice, ceux-là ont la sécurité﴾
4. **La sérénité du cœur**: Il ne craint qu'Allah
5. **La libération de l'esprit**: De la servitude envers autre qu'Allah
6. **La force et la dignité**: En comptant sur Allah seul
