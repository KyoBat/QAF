/**
 * Hajj - Lesson 008: Arafat, Muzdalifa and Mina
 * English Content
 */

export const content = `# 📜 عَرَفَةُ وَمُزْدَلِفَةُ وَمِنَى — Arafat, Muzdalifa and Mina
...
|---------|--------|-------|
| **Imam Malik** رحمه الله | *Al-Mudawwana* | "Whoever misses Arafat has missed the Hajj. And whoever arrives at Arafat at night, before the dawn of the Day of Sacrifice, even for an instant, has attained the Hajj." |
| **Imam Ibn Rushd** رحمه الله | *Bidayat al-Mujtahid* | "The scholars are unanimous that the Wuquf at Arafat is the most important pillar of Hajj, because the Prophet ﷺ said: 'Hajj is Arafat.' And they differ on the status of the night at Muzdalifa and the stoning of the pillars." |
| **Imam an-Nawawi** رحمه الله | *Al-Majmu'* | "The standing at Arafat begins after the zenith of the 9th day and extends until the dawn of the 10th. It is obligatory to stay until sunset according to our school, and it is a recommendation according to others." |
| **Ibn al-Qayyim** رحمه الله | *Zad al-Ma'ad* | "Muzdalifa is called 'al-Mash'ar al-Haram' (the Sacred Monument), and 'Jam'' because pilgrims gather there, and 'Muzdalifa' because one draws near to Allah after departing from Arafat." |
...
|------|------|------------------|-------------------|
| **عَرَفَة (Arafat)** | ʿ-r-f | To know, recognize | Place where Adam and Eve recognized each other, or place of knowing Allah |
| **الوُقوف (al-Wuquf)** | w-q-f | To stand | The station/presence at Arafat |
| **مُزدَلِفة (Muzdalifa)** | z-l-f | To draw near | Place where one draws near to Allah |
| **المَشعَر (al-Mash'ar)** | sh-ʿ-r | To feel, perceive | Monument/sacred place of spiritual perception |
| **مِنى (Mina)** | m-n-y | To wish, desire | Place where wishes are fulfilled |
| **التَّشريق (at-Tashriq)** | sh-r-q | To rise (sun), to dry | Days when meat is dried in the sun |
| **الإفاضة (al-Ifada)** | f-y-ḍ | To overflow, pour forth | The pouring forth of pilgrims from one place to another |
...
|------|--------|-------------|
| **Plain of Arafat** | ✅ Valid | The entire plain is a place of Wuquf |
| **Jabal ar-Rahma** | ✅ Valid | Integral part of Arafat |
| **Valley of 'Uranah** | ⚠️ Outside limits | Does not count for Wuquf |
| **Namira Mosque** | ⚠️ Partially | Front section is outside Arafat |

#### The Time of Wuquf

| Period | Moment | Status |
|--------|--------|--------|
| **Beginning** | After zenith on 9th Dhul-Hijja | Unanimous |
| **End** | Dawn of 10th Dhul-Hijja | Unanimous |
| **Best time** | From afternoon until sunset | Sunnah |
...
| Order | Act | Details |
|-------|-----|---------|
| 1 | Departure from Arafat | After sunset |
| 2 | Combining Maghrib + 'Isha | Upon arrival at Muzdalifa |
| 3 | Night rest | Sleeping under the stars |
| 4 | Collecting pebbles | 7 or 70 stones |
| 5 | Fajr prayer | At its earliest time |
| 6 | Supplications at Mash'ar | Until Isfar (clarity of dawn) |
| 7 | Departure to Mina | Before sunrise |
...
| Day | Acts | Timing |
|-----|------|--------|
| **11th** | Stone 3 Jamarat (7×3 = 21 pebbles) | After zenith |
| **12th** | Stone 3 Jamarat + possible departure | After zenith, before Maghrib |
| **13th** | Stone 3 Jamarat (if stayed) | After zenith |
...
|---------|---------|----------|
| 🟡 **Maliki** | **Stopping even briefly suffices** | Obligation of passage only |
| 🟢 Hanafi | From Fajr to sunrise | Obligation to be present at Fajr time |
| 🔵 Shafi'i | A moment after midnight suffices | Permission to leave after half |
| 🟣 Hanbali | Most of the night | Greater caution |

### 5.2 Status of Night at Muzdalifa

| Madhhab | Status | Compensation |
|---------|--------|--------------|
| 🟡 **Maliki** | **Wajib (obligation)** | **Dam if abandoned without excuse** |
| 🟢 Hanafi | Wajib | Dam obligatory |
| 🔵 Shafi'i | Emphasized Sunnah | No dam |
| 🟣 Hanbali | Wajib | Dam obligatory |

### 5.3 Order of Acts on Day of Sacrifice

| Madhhab | Preferred Order | Is Order Obligatory |
|---------|-----------------|---------------------|
| 🟡 **Maliki** | **Stone → Sacrifice → Shave → Tawaf** | **Recommended, not obligatory** |
| 🟢 Hanafi | Stone → Sacrifice → Shave → Tawaf | Recommended |
| 🔵 Shafi'i | Stone → Sacrifice → Shave → Tawaf | Recommended |
| 🟣 Hanbali | Stone → Sacrifice → Shave → Tawaf | Recommended |
...
| Madhhab | Opinion |
|---------|---------|
| 🟡 **Maliki** | **Permissible for the sick who cannot move** |
| 🟢 Hanafi | Permissible for the sick and incapable |
| 🔵 Shafi'i | Permissible for the incapable |
| 🟣 Hanbali | Permissible in case of absolute necessity |
...
| Mistake | Correction |
|---------|-----------|
| Believing climbing Jabal ar-Rahma is obligatory | This is an innovation, the entire plain of Arafat is valid for Wuquf |
| Leaving Arafat before sunset | Obligation to stay until Maghrib according to the majority |
| Praying Maghrib and 'Isha separately on the road | They must be combined at Muzdalifa |
| Believing the pebble must hit the pillar | It suffices for the stone to fall in the basin |
| Throwing all pebbles at once | Each pebble must be thrown separately with Takbir |
| Collecting pebbles only from Muzdalifa | They can be collected from anywhere |
| Cursing Satan while stoning | The Sunnah is only Takbir |
...
| Day | Location | Acts | Times |
|-----|----------|------|-------|
| 8th Dhul-Hijja | Mina | Prayers at Mina, overnight | All day |
| 9th Dhul-Hijja morning | Arafat | Departure to Arafat | After sunrise |
| 9th Dhul-Hijja afternoon | Arafat | Wuquf, Dhuhr+'Asr, supplications | Until Maghrib |
| Night of 10th | Muzdalifa | Maghrib+'Isha, rest, Fajr, dhikr | Until before sunrise |
| 10th Dhul-Hijja | Mina | Stoning, sacrifice, shaving, Tawaf, Sa'i | All day |
| 11-12(-13) | Mina | Stoning 3 Jamarat, nights | After zenith |
