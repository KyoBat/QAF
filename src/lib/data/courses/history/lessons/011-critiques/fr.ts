/**
 * Histoire Islamique - Leçon 011 : Critiques et Défenses
 * انتقادات ودفاعات
 * 
 * Les controverses autour des 4 écoles et leurs réponses
 */

export const content = `# ⚔️ Critiques et Défenses — انْتِقَادَاتٌ وَدِفَاعَات
...
3. **Ses élèves ont compilé des hadiths** : Le *Kitāb al-Āthār* d'Abū Yūsuf et de Muḥammad al-Shaybānī.
...
3. **Il n'a pas rejeté les hadiths** : Il les a hiérarchisés.
...
2. **Il a voyagé et appris** : En Égypte, il a découvert de nouveaux hadiths.

3. **Les deux avis sont précieux** : Ils montrent le processus de réflexion.
...
3. La critique était **méthodologique**, pas personnelle.
...
3. **Ses élèves ont compilé** : *Masā'il al-Imām Aḥmad* par ses fils Ṣāliḥ et 'Abd Allāh.
...
3. **Ibn Taymiyya a défendu cette approche** comme étant la plus proche de la Sunna.
...
3. **Son courage a sauvé la doctrine sunnite** : Sans lui, le mu'tazilisme aurait peut-être dominé.

---

## 📊 Tableau Récapitulatif des Critiques

| Imam | Critique principale | Réponse clé |
|------|---------------------|-------------|
...
| Point | Détail |
|-------|--------|
| **Critiques existaient** | Aucun imam n'a échappé aux controverses |
| **Réponses solides** | Chaque critique a été réfutée par les savants ultérieurs |
| **Faillibilité assumée** | Les 4 ont reconnu pouvoir se tromper |
| **Respect obligatoire** | Critiquer un avis ≠ manquer de respect à l'imam |
