/**
 * Islamic History - Lesson 003: When the Imams Met
 * لقاءات الأئمة
 * 
 * Historic moments when the four imams crossed paths
 */

export const content = `# 🤝 When the Imams Met — لِقَاءَاتُ الْأَئِمَّةِ
...
| Meeting | Location | Period | Documented? |
|---------|----------|--------|-------------|
| 🟢 Abū Ḥanīfa ↔ 🟡 Mālik | Medina / Mecca | ~150 AH | ✅ Yes |
| 🟢 Abū Ḥanīfa ↔ 🔵 Al-Shāfi'ī | — | — | ❌ No (Abū Ḥanīfa died when Shāfi'ī was 4) |
| 🟡 Mālik ↔ 🔵 Al-Shāfi'ī | Medina | 163-179 AH | ✅ Yes (9 years of study) |
| 🟡 Mālik ↔ 🟣 Aḥmad | — | — | ❌ No (no direct meeting documented) |
| 🔵 Al-Shāfi'ī ↔ 🟣 Aḥmad | Baghdad | 195-199 AH | ✅ Yes (several years) |
...
| Encounter | Duration | Impact |
|-----------|----------|--------|
| 🟢 Abū Ḥanīfa ↔ 🟡 Mālik | A few days | Mutual respect despite methodological differences |
| 🟡 Mālik → 🔵 Al-Shāfi'ī | ~9 years | Formation of the Shafi'i foundation |
| 🔵 Al-Shāfi'ī ↔ Al-Shaybānī | ~2 years | Medina-Kufa synthesis |
| 🔵 Al-Shāfi'ī → 🟣 Aḥmad | ~4 years | Transmission of methodology |
