/**
 * Islamic History - Lesson 002: Their Common Teachers
 * شيوخهم المشتركون
 * 
 * The chains of transmission that connect the four imams
 */

export const content = `# 🔗 Their Common Teachers — شُيُوخُهُمُ الْمُشْتَرَكُونَ
...
## 🗺️ Map of Transmissions

Explore these connections through the interactive map below 👇

> 💡 **Use the + and − buttons to expand and collapse branches**
