/**
 * Lesson 19: How to Choose a Madhab?
 */

export const content = `# ⚖️ How to Choose a Madhab?
...
| Region | Dominant Madhab |
|--------|-----------------|
| **Turkey, Indian subcontinent, Central Asia** | Hanafi |
| **Morocco, North Africa, West Africa** | Maliki |
| **Indonesia, Malaysia, Egypt, Yemen** | Shafi'i |
| **Saudi Arabia, Gulf** | Hanbali |
...
|-----------|------------|
| **Books of the madhab** | Do you find them in your language? |
| **Specialized scholars** | Is there someone to ask? |
| **Courses and programs** | Are they available in your language? |

### 4. Personal Preference (Methodology)

| Madhab | Distinctive Characteristic |
|--------|---------------------------|
| **Hanafi** | Facilitation, ijtihad, flexibility |
| **Maliki** | Medina tradition, practice of its people |
| **Shafi'i** | Clear methodology, moderation |
| **Hanbali** | Adherence to text, precaution |
...
|-----------|-------------|
| **Intention** | Don't change just to follow the easiest |
| **Knowledge** | Learn the new madhab well |
| **Commitment** | Don't jump from one madhab to another randomly |
| **Consultation** | Ask a scholar before changing |
...
| Type | Ruling |
|------|--------|
| **Acceptable talfiq** | On different issues (my prayer is Shafi'i, my fasting is Hanafi) |
| **Rejected talfiq** | On the same issue in a way that contradicts all madhabs |
