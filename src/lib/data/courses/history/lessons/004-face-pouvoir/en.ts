/**
 * Islamic History - Lesson 004: Facing the Authorities
 * الأئمة والسلطة
 * 
 * How the four imams confronted political power
 */

export const content = `# ⚔️ Facing the Authorities — الْأَئِمَّةُ وَالسُّلْطَةُ
...
1. Power corrupts a scholar's independence
2. A judge appointed by the caliph would be under political pressure
3. He might have to render unjust verdicts
