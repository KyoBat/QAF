/**
 * Islamic History - Lesson 010: The Geography of the Schools
 * جغرافية المذاهب
 * 
 * Where the 4 schools spread and why
 */

export const content = `# 🗺️ The Geography of the Schools — جُغْرَافِيَةُ المَذَاهِبِ
...
1. Aḥmad refused official positions
2. No adoption by a great empire (before the Saudis)
3. Strong theological resistance
