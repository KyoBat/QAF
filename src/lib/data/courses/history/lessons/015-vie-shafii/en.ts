/**
 * Islamic History - Lesson 15: The Life of Imam al-Shafi'i
 * Complete Biography of the Defender of the Sunna (150-204 H)
 */

export const content = `# 🕌 The Life of Imam al-Shafi'i (150-204 H)
...
| Information | Details |
|-------------|---------|
| **Full Name** | Muhammad ibn Idris ibn al-'Abbas al-Shafi'i |
| **Nickname** | Abu 'Abd Allah |
| **Birth** | Gaza, 150 H (767 CE) — same year as Abu Hanifa's death |
| **Lineage** | Qurayshi Muttalibid, meets the Prophet ﷺ through his ancestor |
...
| Age | Accomplishment |
|-----|----------------|
| **7 years** | Memorization of the Quran |
| **10 years** | Complete memorization of the Muwatta |
| **15 years** | Authorized to give fatawas |
| **Early youth** | Journey to Malik |
...
| Aspect | Details |
|--------|---------|
| **Tribe** | Hudhayl (the most eloquent of Arabs) |
| **Duration** | Several years |
| **What he learned** | Poetry, language, genealogies, horsemanship |
| **Archery** | 9 out of 10 arrows in the target |
...
| Source | What he took |
|--------|--------------|
| **Hudhayl** | Language, poetry, and eloquence |
| **Malik** | Hadith and fiqh of Medina |
| **Al-Shaybani** | Fiqh of Iraq and reasoning |
| **Experience** | Judiciary in Yemen |
...
| Place | Purpose | Period |
|-------|---------|--------|
| **Gaza** | Birth | 150 H |
| **Mecca** | Education and learning | 152-170 H |
| **Medina** | Studies with Malik | ~170-175 H |
| **Yemen** | Work as judge | ~175-184 H |
| **Baghdad (1st time)** | Teaching | ~184-188 H |
| **Mecca** | Teaching | ~188-195 H |
| **Baghdad (2nd time)** | Teaching | ~195-199 H |
| **Egypt** | Final settlement | 199-204 H |
...
| Information | Details |
|-------------|---------|
| **Name** | Al-Risala (The Treatise) |
| **Importance** | First book of Usul al-Fiqh |
| **Request** | Written at the request of 'Abd al-Rahman ibn Mahdi |
| **Revolution** | Systematized the rules of deriving judgments |
...
| **2. The Sunna** | The explanation of the Quran |
| **3. Ijma'** | The consensus of scholars |
| **4. Qiyas** | Analogy from the derivative to the original |
...
| Al-Shafi'i influenced Ahmad | Ahmad influenced al-Shafi'i |
|-----------------------------|----------------------------|
| Taught him Usul al-Fiqh | Informed him of hadiths he didn't know |
| Methodology of deduction | Precision in hadith narration |
| Union of the two schools | Verification and validation |
...
| Information | Details |
|-------------|---------|
| **Date of death** | Last night of Rajab 204 H (820 CE) |
| **Place** | Fustat, Egypt |
| **Age** | Only 54 years |
| **Burial place** | Cairo Cemetery (mausoleum today) |
...
| Disciple | Role |
|----------|------|
| **Al-Rabi' ibn Sulayman al-Muradi** | Narrator of his books in Egypt |
| **Al-Muzani** | Propagator of the new madhab |
| **Al-Buwayti** | His successor in his circle |
| **Harmala ibn Yahya** | Among the great narrators of his books |
...
|--------|-------|--------------|
| **Childhood** | 150-160 H | Birth as orphan, move to Mecca |
| **Formation** | 160-175 H | Hudhayl, Malik, memorizing the Muwatta |
| **Journeys** | 175-199 H | Yemen, Baghdad, Mecca |
| **Settlement** | 199-204 H | Egypt, the new madhab |
| **Death** | 204 H | Cairo, 54 years old |
