/**
 * Islamic History - Lesson 005: Their Methodologies
 * مناهجهم في الاستنباط
 * 
 * How each imam derived legal rulings
 */

export const content = `# 📐 Their Methodologies — مَنَاهِجُهُمْ فِي الاسْتِنْبَاطِ
