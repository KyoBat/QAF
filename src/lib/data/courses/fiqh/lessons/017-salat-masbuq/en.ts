/**
 * Fiqh - Lesson 017: Prayer of the Late-Comer (Masbuq)
 * English Content
 */
...
|----------------|--------|
| **Caught the bowing** | Caught the complete rak'a |
| **Caught the imam after bowing** (in prostration or sitting) | Missed this rak'a |
| **Caught only the final tashahhud** | Caught the virtue of congregation but missed all rak'at |
...
|-----------|-------------|
| **1. Catch the imam in bowing** | Before the imam raises his head |
...
| What he catches | What he does after the imam's salam |
|-----------------|-------------------------------------|
| **One rak'a of Maghrib** | He stands and prays one rak'a with Fatiha and surah (aloud), then sits for tashahhud, then stands for the third with Fatiha only (silently) |
...
| What he makes up | What he recites |
|------------------|-----------------|
...
| What he catches | Ruling |
|-----------------|--------|
| **Caught one complete rak'a** | Caught Jumu'a, he completes the second rak'a |
| **Caught less than one rak'a** | Missed Jumu'a, he completes it as Dhuhr with four rak'at |
...
|-----------|--------------|
| **Caught one rak'a** | He stands after the imam's salam and prays one rak'a with Fatiha and surah (aloud) and makes salam |
| **Caught less than one rak'a** | He completes four rak'at as Dhuhr (he stands and prays three more rak'at like Dhuhr) |

### 3. Important issues regarding Jumu'a

| Issue | Ruling |
|-------|--------|
| He enters while the imam is in the final tashahhud | He joins him then prays four rak'at as Dhuhr |
| He enters while the imam is in the final prostration | He joins him then prays four rak'at as Dhuhr |
| Caught the second bowing | Caught Jumu'a |
| Caught the first bowing but not the second | Caught Jumu'a (caught one complete rak'a) |
...
| If the imam forgets | If the masbuq forgets |
|---------------------|----------------------|
| He follows his imam in prostration | He does not prostrate with him, but prostrates for himself after completing his prayer |

### The Detail:

| Situation | Ruling |
|-----------|--------|
| **The imam forgot and prostrated before salam** | The masbuq follows him |
| **The imam forgot and prostrated after salam** | The masbuq follows him then stands to make up |
| **The masbuq forgot in what he makes up** | He prostrates for his forgetfulness at the end of his prayer |
...
|--------|-----------------|------------------|----------------|
| **Fajr** | 1 rak'a | 1 rak'a | Fatiha + surah (aloud) |
| **Dhuhr** | 3 rak'at | 1 rak'a | Fatiha only (silently) |
| **Dhuhr** | 2 rak'at | 2 rak'at | Fatiha + surah for the first, then tashahhud, then Fatiha only |
| **Dhuhr** | 1 rak'a | 3 rak'at | Fatiha + surah (2 rak'at) + tashahhud + Fatiha only |
| **'Asr** | Like Dhuhr | Like Dhuhr | Like Dhuhr |
| **Maghrib** | 2 rak'at | 1 rak'a | Fatiha only (silently) |
| **Maghrib** | 1 rak'a | 2 rak'at | Fatiha + surah (aloud) + tashahhud + Fatiha + surah (aloud) |
| **'Isha** | 3 rak'at | 1 rak'a | Fatiha only (silently) |
| **'Isha** | 2 rak'at | 2 rak'at | Fatiha + surah (aloud) × 2 |
| **'Isha** | 1 rak'a | 3 rak'at | Fatiha + surah (aloud) × 2 + tashahhud + Fatiha only (silently) |
| **Jumu'a** | 1 rak'a | 1 rak'a | Fatiha + surah (aloud) |
| **Jumu'a** | Less than 1 rak'a | 3 rak'at (as Dhuhr) | He prays it as complete Dhuhr |
