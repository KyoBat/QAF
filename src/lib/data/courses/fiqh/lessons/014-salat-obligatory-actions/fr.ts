/**
 * Fiqh - Leçon 014 : Les obligations de la Salat
 * Contenu en Français
 */
...
> L'Imam Ahmad a dit : *"Les obligations sont en-dessous des piliers, mais il ne convient pas au musulman de les négliger."*
...
- **La sunna :** Ce pour quoi celui qui l'accomplit est récompensé et celui qui l'omet n'est pas puni, mais elle augmente la récompense et l'humilité.
...
|----|------------|-------------------|-----------------|
| 1 | **Tous les takbirs autres que le takbir d'ouverture** | Hadith de Wa'il ibn Hujr : « Le Prophète ﷺ, quand il se levait pour la prière, disait : Allahu Akbar... » — Abu Dawud (734) | Inclut les transitions entre les piliers |
| 2 | **Dire : Sami'a Allahu liman hamidah** pour l'imam et celui qui prie seul | Hadith d'Abu Hurayra sur la description de la prière — Al-Bukhari (789) | Le suiveur dit : Rabbana wa laka al-hamd |
| 3 | **Dire : Rabbana wa laka al-hamd** pour tous | Unanimement reconnu — Al-Bukhari (795) | On peut ajouter les formules rapportées |
| 4 | **Le tasbih de l'inclinaison** (une fois) | « Quant à l'inclinaison, glorifiez-y le Seigneur » — Muslim (479) | Au minimum : Subhana rabbi al-'azim |
| 5 | **Le tasbih de la prosternation** (une fois) | « Quant à la prosternation, efforcez-vous dans l'invocation » — Muslim (479) et le sens du tasbih est établi dans plusieurs hadiths | Au minimum : Subhana rabbi al-a'la |
| 6 | **Dire : Rabbi ghfir li** entre les deux prosternations | Hadith de Hudhayfa : « Et il disait entre les deux prosternations : Rabbi ghfir li, Rabbi ghfir li » — Abu Dawud (874) | On peut ajouter les formules rapportées comme : warhamni |
| 7 | **Le premier tashahhud** | Hadith d'Ibn Mas'ud : « Nous disions avant que le tashahhud ne nous soit imposé... » — Muslim (402) | Son omission par oubli est compensée par la prosternation de l'oubli |
| 8 | **L'assise pour le premier tashahhud** | C'est une conséquence du tashahhud lui-même, il en prend donc le statut | S'asseoir avec une légère sérénité |

> **Remarque :** Certaines écoles diffèrent dans le nombre et les détails, mais cette liste est choisie pour ce qui convient aux jeunes tout en respectant les preuves.
...
3. **Son emplacement :**
   - Après le salam : lors d'un ajout dans la prière ou d'un doute où l'ajout prédomine.
   - Avant le salam : lors de l'omission d'une obligation ou d'un doute équivalent.
4. **La preuve :** Hadith d'Abdullah ibn Buhayna sur la prosternation du Prophète ﷺ avant le salam lors de l'omission du premier tashahhud — Al-Bukhari (829), et hadith de Dhu al-Yadayn sur la prosternation après le salam — Muslim (573).
...
3. **Révision en groupe :** Discute avec tes camarades des différences entre l'obligation et la sunna à chaque emplacement.
...
3. Cite un hadith qui prouve la légitimité de la prosternation de l'oubli.

Ô Allah, accorde-nous la réussite dans l'accomplissement de la prière comme Tu l'as ordonné, enseigne-nous ce qui nous est utile, et fais de nous des humbles qui accomplissent les obligations et les sunan de la meilleure façon.
`;