/**
 * Fiqh - Lesson 027: قضاء الفوائت (Making Up Missed Prayers)
 * English Content
 */
...
| School | Status of makeup |
|--------|------------------|
| 🟡 **Maliki** | **Obligatory** immediately |
| 🟢 Hanafi | Obligatory immediately |
| 🔵 Shafi'i | Obligatory but not immediately |
| 🟣 Hanbali | Obligatory immediately |
...
| School | Order obligatory? |
|--------|-------------------|
| 🟡 **Maliki** | ✅ **Yes** — unless many or order forgotten |
...
| School | Must they make up prayers from apostasy? |
|--------|------------------------------------------|
| 🟡 **Maliki** | ❌ **No** — previous deeds are nullified |
| 🟢 Hanafi | ❌ No |
| 🔵 Shafi'i | ✅ **Yes** — must make up |
| 🟣 Hanbali | ❌ No |
...
| School | Must it be made up? |
|--------|---------------------|
| 🟡 **Maliki** | ✅ **Yes** — sin doesn't exempt from makeup |
| 🟢 Hanafi | ✅ Yes |
| 🔵 Shafi'i | ✅ Yes |
...
| Aspect | Rule |
|--------|------|
| **Congregation or alone** | Both valid |
| **Recitation** | Silently, even for Fajr/Maghrib/Isha if daytime |
| **Number of rak'at** | Same as original prayer |
| **Travel** | If missed while traveling → 2 rak'at. While resident → full |
...
| Point | Maliki Ruling |
|-------|---------------|
| **Status** | Obligatory immediately |
| **Order** | Obligatory (if few) |
| **Priority** | Missed before current (if time is wide) |
| **Returned apostate** | Does not make up apostasy period |
| **Deliberate abandonment** | Must make up + repent |
| **Prohibited time** | Permitted for makeup |
