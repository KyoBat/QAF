/**
 * Fiqh - Leçon 020: صلاة المريض (La Prière du Malade)
...
|----------|----------|-------|-----------|
| 1️⃣ | **Debout** | قائم | Obligatoire si capable |
| 2️⃣ | **Assis** | قاعد | Si incapable de se tenir debout |
| 3️⃣ | **Sur le côté** | على جنب | Si incapable de s'asseoir |
...
| Situation | Règle |
|-----------|-------|
| **Appui léger (canne, mur)** | Permis si nécessaire |
...
|----------|-------------|------|
| **Tarabbu' (en tailleur)** | Jambes croisées | ✅ Recommandé (Maliki) |
...
|----------|----------|-----------|
| **Côté droit** | 1️⃣ Préféré | Visage vers la Qibla |
...
| Situation | Règle |
|-----------|-------|
| **L'eau lui nuit** | Tayammum obligatoire |
| **Incapable de faire le wudu seul** | Quelqu'un l'aide |
