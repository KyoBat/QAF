...
| :--- | :--- |
| Supplication before entering | Facing the Qiblah (in open areas) |
| Entering with left foot | Turning back to Qiblah (in open areas) |
| Supplication after exiting | Urinating in stagnant water |
| Exiting with right foot | Urinating on pathways or in shade |
| Cleansing with water | Speaking while relieving oneself |
| Wiping an odd number (3, 5, 7) | Using the right hand for Istinja |
