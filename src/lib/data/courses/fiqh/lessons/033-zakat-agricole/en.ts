/**
 * Fiqh - Lesson 033: زكاة الزروع والثمار (Zakat on Agricultural Produce)
 * English Content - Multi-Madhhab Approach (Maliki Priority)
 */

export const content = `# Zakat on Agricultural Produce (زكاة الزروع والثمار)
