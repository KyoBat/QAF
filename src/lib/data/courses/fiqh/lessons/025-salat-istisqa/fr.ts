/**
 * Fiqh - Leçon 025: صلاة الاستسقاء (La Prière pour la Pluie)
...
|--------|-------------|--------|
| **1. Du'a simple** | Invoquer Allah à tout moment | Minimum |
...
|-------------|-------------|
| **Jeûne** | Recommandé 3 jours avant |
| **Sadaqa** | Donner l'aumône |
| **Tawba** | Se repentir sincèrement |
