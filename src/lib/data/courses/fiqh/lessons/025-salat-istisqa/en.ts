...
export const content = `# 📜 صَلَاةُ الِاسْتِسْقَاءِ — The Rain Prayer
...
1. **Fast three days** — Before the prayer if possible
2. **Repent and reconcile** — Between you and Allah and people
3. **Go out humbly** — Without perfume or finery
4. **Pray two rak'at** — With the congregation
5. **Supplicate with humility** — Raise hands with backs toward sky
6. **Turn your cloak** — Hoping for change of situation
...
1. **Sahih Al-Bukhari** — Hadith: 1012, 1027
2. **Sahih Muslim** — Hadith: 895, 898
