/**
 * Fiqh - Lesson 019: صلاة المسافر (Traveler's Prayer)
...
|--------|--------------|-----------------|
| **Fajr** | 2 rak'at | 2 rak'at (no change) |
...
|--------|------------------|-------------------|
| 🟡 **Maliki** | **4 burud (48 Hashimi miles)** | **≈ 81 km** |
| 🟢 Hanafi | 3 days walk | ≈ 80-90 km |
...
- Distance is calculated **one way**, not round trip
...
|--------|-------------------------|
| 🟡 **Maliki** | **When leaving the buildings of one's city** |
| 🟢 Hanafi | When leaving the dwellings of one's city |
