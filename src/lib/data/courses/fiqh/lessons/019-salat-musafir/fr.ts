/**
 * Fiqh - Leçon 019: صلاة المسافر (La Prière du Voyageur)
...
|----------|-------------|
| **Le Raccourcissement (القصر)** | Réduire les prières de 4 rak'at à 2 |
| **Le Regroupement (الجمع)** | Combiner deux prières en une seule heure |
| **Rompre le jeûne** | Permis de ne pas jeûner Ramadan (rattraper après) |
...
|--------|---------------|-----------|
| **Fajr** | 2 rak'at | 2 rak'at (pas de changement) |
| **Dhuhr** | 4 rak'at | **2 rak'at** |
| **Asr** | 4 rak'at | **2 rak'at** |
...
|-------|----------------------------|
| 🟡 **Maliki** | **Dès qu'on quitte les constructions de sa ville** |
| 🟢 Hanafi | En quittant les habitations de sa ville |
...
|------------------------|--------|--------|
| 1-4 jours complets | Voyageur | Raccourcir + regrouper |
| 5 jours ou plus | Résident | Prier complet |
| Incertain de la durée | Voyageur | Raccourcir jusqu'à 18 jours max |
