/**
 * Fiqh - Lesson 015: Sunan and Nullifiers of Salah
 * English Content
 */
...
3. **Straighten the rows:** Especially in congregation, this helps with tranquility.
4. **Lower the gaze and voice:** Helps with presence of heart.
5. **Commit to dhikr after prayer:** It completes the deficiency that occurred in the sunan.
...
3. What is the wisdom behind raising the hands when bowing and rising?
4. How do you deal with whispers and movement during prayer?
