/**
 * Fiqh - Leçon 021: صلاة الجمعة (La Prière du Vendredi)
...
|-----------|-------------|
| **Être musulman** | Évident |
| **Être homme** | Les femmes en sont exemptées |
| **Être libre** | L'esclave en est exempté (historique) |
| **Être résident** | Le voyageur en est exempté |
| **Être sain** | Le malade en est exempté |
...
|-----------|-----------|---------------|
| **Le temps** | Après le zénith | Après le zénith |
...
| # | Pilier | Description |
|---|--------|-------------|
| 1 | **Louange à Allah** | Commencer par "Al-Hamdulillah" |
| 2 | **Prière sur le Prophète ﷺ** | "Allahumma salli 'ala Muhammad" |
...
| Sunna | Description |
|-------|-------------|
| **Être debout** | Sur le minbar ou une élévation |
| **Saluer l'assemblée** | En montant |
