/**
 * Islamic History - Lesson 003: 'Uthmān ibn 'Affān
 * عثمان بن عفان
 * 
 * Modesty incarnate, generosity without limits
 */

export const content = `# 🕊️ 'Uthmān ibn 'Affān — The Possessor of Two Lights
...
1. **Ruqayya** — who died during the Battle of Badr
2. **Umm Kulthūm** — who died in 9 AH
