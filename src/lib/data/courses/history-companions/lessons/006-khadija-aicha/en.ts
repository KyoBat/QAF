/**
 * Islamic History - Lesson 006: Khadīja and 'Ā'isha
 * خديجة وعائشة
 * 
 * The Mothers of the Believers — the most beloved to the Prophet ﷺ
 */

export const content = `# 👑 Khadīja and 'Ā'isha — The Two Beloved
