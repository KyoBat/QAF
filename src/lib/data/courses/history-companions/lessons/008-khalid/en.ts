/**
 * Islamic History - Lesson 8: The Sword of Allah — Khālid ibn al-Walīd
 * L'Épée d'Allah — Khālid ibn al-Walīd
 */

export const content = `# ⚔️ THE SWORD OF ALLAH — Khālid ibn al-Walīd
...
| Information | Details |
|-------------|---------|
| **Name** | Khālid ibn al-Walīd ibn al-Mughīra |
| **Clan** | Banū Makhzūm (Quraysh aristocracy) |
| **Father** | al-Walīd ibn al-Mughīra, chief of Makhzūm |
| **Initial Role** | Commander of Quraysh cavalry |
| **Conversion** | 8 AH, just before the conquest of Mecca |
| **Death** | 21 AH, Homs (Syria) |
...
|--------|------|----------|--------|
| Chains | 12 AH | Persians | Victory |
| Ullays | 12 AH | Persians | Victory |
| Walaja | 12 AH | Persians | Victory |
| Ḥīra | 12 AH | Persians | Victory |
...
| **Battles fought** | ~100 |
| **Battles lost** | 0 |
| **Empires defeated** | 2 (Persia + Byzantium) |
| **Territory conquered** | Millions of km² |
