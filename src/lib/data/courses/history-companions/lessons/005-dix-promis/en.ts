/**
 * Islamic History - Lesson 005: The Ten Promised Paradise
 * العشرة المبشرون بالجنة
 * 
 * Overview of the ten Companions to whom the Prophet ﷺ promised Paradise
 */

export const content = `# 🌟 The Ten Promised Paradise — The Chosen Ones
...
| # | Name | Title/Characteristic | Death |
|---|------|---------------------|-------|
| 1 | **Abū Bakr al-Ṣiddīq** | The Truthful | 13 AH |
| 2 | **'Umar ibn al-Khaṭṭāb** | The Distinguisher | 23 AH |
| 3 | **'Uthmān ibn 'Affān** | The Possessor of Two Lights | 35 AH |
| 4 | **'Alī ibn Abī Ṭālib** | The Lion of Allah | 40 AH |
| 5 | **Ṭalḥa ibn 'Ubaydullāh** | The Generous | 36 AH |
| 6 | **Al-Zubayr ibn al-'Awwām** | The Disciple of the Prophet | 36 AH |
| 7 | **'Abd al-Raḥmān ibn 'Awf** | The Philanthropist | 32 AH |
| 8 | **Sa'd ibn Abī Waqqāṣ** | The First Archer | 55 AH |
| 9 | **Sa'īd ibn Zayd** | The Witness of Truth | 51 AH |
| 10 | **Abū 'Ubayda ibn al-Jarrāḥ** | The Trustworthy One | 18 AH |
...
| Information | Detail |
|-------------|--------|
| **Clan** | Taym (same clan as Abū Bakr) |
| **Conversion** | Among the first, through Abū Bakr |
| **Title** | Ṭalḥa al-Khayr (the Generous) |
...
| Information | Detail |
|-------------|--------|
| **Family Link** | Son of Ṣafiyya, the Prophet's ﷺ aunt |
| **Conversion** | 5th or 6th man, at 15 years old |
| **Title** | Ḥawārī Rasūlillāh (Disciple of the Messenger) |
...
|-------------|--------|
| **Clan** | Zuhra |
| **Conversion** | Before Dār al-Arqam |
| **Title** | The Wealthiest of the Companions |
...
| Information | Detail |
|-------------|--------|
| **Clan** | Zuhra (maternal uncle of the Prophet ﷺ) |
| **Conversion** | 7th man, at 17 years old |
| **Title** | First to shoot an arrow for Islam |
...
| **Conversion** | Among the first, with his wife Fāṭima |
| **Relation** | Brother-in-law of 'Umar |
...
|-------------|--------|
| **Clan** | Fihr |
| **Conversion** | Very early, with Abū Bakr |
| **Title** | Amīn al-Umma (The Trustworthy One of the Umma) |
...
|----------------|--------|
| **Early Conversion** | All among the first Muslims |
| **Emigration** | All emigrated for Islam |
| **Badr** | Nine out of ten participated (Sa'īd was on a mission) |
| **Sacrifice** | All risked their lives and wealth |
| **Integrity** | No compromise on truth |
...
| Companion | Distinctive Trait |
|-----------|------------------|
| Abū Bakr | Immediate faith |
| 'Umar | Strength and justice |
| 'Uthmān | Modesty and generosity |
| 'Alī | Knowledge and bravery |
| Ṭalḥa | Protection of the Prophet ﷺ |
| Al-Zubayr | First to draw his sword |
| 'Abd al-Raḥmān | Wealth in service of Islam |
| Sa'd | Archer and conqueror |
| Sa'īd | Discretion and piety |
| Abū 'Ubayda | Absolute trust |
