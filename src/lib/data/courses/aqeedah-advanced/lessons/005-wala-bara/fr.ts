...
const content = `
# 🤝 L'Alliance et le Désaveu — Concept et Règles

> **﴿ يَا أَيُّهَا الَّذِينَ آمَنُوا لَا تَتَّخِذُوا الْيَهُودَ وَالنَّصَارَىٰ أَوْلِيَاءَ ﴾**
> *« Ô vous qui avez cru, ne prenez pas les Juifs et les Chrétiens comme alliés. »*
> — [Al-Mâ'idah : 51]

---

## 📚 Définition de l'Alliance et du Désaveu

### Sens linguistique
| Terme | Signification |
|-------|---------------|
| **Al-Walâ' (الولاء)** | La proximité, le soutien et l'amour |
| **Al-Barâ' (البراء)** | L'éloignement, la séparation et la haine |

### Sens terminologique
| Terme | Définition |
|-------|------------|
| **Al-Walâ'** | Aimer les croyants, les soutenir et se rapprocher d'eux |
| **Al-Barâ'** | Détester les mécréants, s'éloigner d'eux et les prendre comme ennemis pour Allah |

---

## ⚡ Importance de l'Alliance et du Désaveu

### Dans la foi

| Preuve | Signification |
|--------|---------------|
| ﴿ إِنَّمَا وَلِيُّكُمُ اللَّهُ وَرَسُولُهُ وَالَّذِينَ آمَنُوا ﴾ | L'alliance est pour les croyants |
| ﴿ وَالَّذِينَ كَفَرُوا بَعْضُهُمْ أَوْلِيَاءُ بَعْضٍ ﴾ | Les mécréants s'allient entre eux |
| ﴿ لَّا تَجِدُ قَوْمًا يُؤْمِنُونَ بِاللَّهِ... يُوَادُّونَ مَنْ حَادَّ اللَّهَ ﴾ | Négation de la foi pour celui qui s'allie aux mécréants |
...
## 📋 Niveaux de l'Alliance et du Désaveu

### Niveaux d'alliance envers les croyants

| Niveau | Exemple |
|--------|---------|
| **L'amour pour Allah** | Aimer les gens de foi et d'obéissance |
| **Le soutien** | Les aider et les assister |
| **L'alliance** | La proximité et le soutien |

### Niveaux de désaveu des mécréants

| Niveau | Jugement |
|--------|----------|
| **La haine pour Allah** | Obligatoire |
| **Ne pas les imiter** | Obligatoire dans ce qui leur est spécifique |
| **Ne pas les soutenir contre les musulmans** | Obligatoire, peut être un annulateur |

---

## ⚠️ L'Alliance Interdite et Annulatrice

### L'alliance qui annule l'Islam

| Forme | Preuve |
|-------|--------|
| **Aider les mécréants contre les musulmans** | ﴿ وَمَن يَتَوَلَّهُم مِّنكُمْ فَإِنَّهُ مِنْهُمْ ﴾ |
| **Être satisfait de leur mécréance** | Fait sortir de la religion |
| **Aimer leur mécréance et leur religion** | Fait sortir de la religion |

### L'alliance interdite mais non annulatrice

| Forme | Jugement |
|-------|----------|
| **Les flatter par peur** | Interdit mais pas mécréance |
| **Pencher vers eux pour ce monde** | Grand péché |
| **Les imiter dans ce qui n'est pas une adoration** | Interdit ou détestable |

---

## ✅ Ce qui est Permis avec les Mécréants

### Les relations permises

| Affaire | Preuve |
|---------|--------|
| **L'achat et la vente** | Le Prophète ﷺ a traité avec les Juifs |
| **La justice envers eux** | ﴿ وَلَا يَجْرِمَنَّكُمْ شَنَآنُ قَوْمٍ عَلَىٰ أَلَّا تَعْدِلُوا ﴾ |
| **La bienfaisance envers les non-combattants** | ﴿ لَّا يَنْهَاكُمُ اللَّهُ عَنِ الَّذِينَ لَمْ يُقَاتِلُوكُمْ ﴾ |
| **Les liens de parenté mécréante** | Asmâ' bint Abî Bakr et sa mère |
| **L'appel à l'Islam** | Les inviter à l'Islam |
...
**Réponse** : Non, selon la majorité des savants, car c'est approuver leurs rites faux.

### Q2 : Quelle différence entre l'alliance (Muwâlât) et la complaisance (Mudârât) ?

| L'alliance (Muwâlât) | La complaisance (Mudârât) |
|----------------------|---------------------------|
| Amour du cœur et soutien | Adoucir la parole pour repousser le mal |
| Interdite ou annulatrice | Permise par intérêt |

### Q3 : La haine des mécréants signifie-t-elle l'injustice envers eux ?

**Réponse** : Non, la haine est dans le cœur pour leur mécréance, mais la justice est obligatoire envers tous.
...
export const lesson005Fr = {
  title: 'L\'Alliance et le Désaveu — Concept et Règles',
  content,
}
