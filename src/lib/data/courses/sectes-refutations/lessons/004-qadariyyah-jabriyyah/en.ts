export const contentEn = `# 🎯 The Qadariyyah and Jabriyyah — Predestination Between Denial and Exaggeration
...
| Jabrite Belief | Absurd Consequence |
|----------------|-------------------|
...
| Question | Answer of Ahl as-Sunnah |
|----------|-------------------------|
...
| Concept | Definition |
|---------|------------|
| **Qadariyyah** | Deniers of destiny — say man creates his actions |
| **Jabriyyah** | Exaggerators — say man has no choice |
| **The 4 Levels** | Knowledge, Writing, Will, Creation |
| **Sunni Position** | Allah creates everything + man has real choice |
| **Practical Rule** | Take causes + trust in Allah |
