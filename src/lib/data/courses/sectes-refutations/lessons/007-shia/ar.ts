...
\`\`\`
الشيعة — أنصار علي رضي الله عنه
│
├── 🟢 الزيدية (الأقرب للسنة)
│   └── المؤسس: زيد بن علي (ت 122هـ)
│   └── يقبلون أبا بكر وعمر
│   └── منتشرون في اليمن
│
...
│   └── أكبر فرقة اليوم
│   └── 12 إماماً معصوماً
│   └── إيران، العراق، لبنان، البحرين
│
├── 🟣 الإسماعيلية
│   └── انفصلوا عند الإمام السابع (إسماعيل مقابل موسى)
│   └── الفروع: الفاطميون، القرامطة، الأغاخانية
│   └── عقائد باطنية
│
└── ⚫ الغلاة
    └── ألّهوا علياً أو الأئمة
    └── النصيرية (العلويون)، الدروز
    └── خرجوا من الإسلام بالإجماع
\`\`\`
