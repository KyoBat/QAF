export const contentEn = `# 🕌 The Shi'a — Origins, Branches and Responses
...
| # | Imam | Relation | Death |
|---|------|----------|-------|
| 1 | 'Ali ibn Abi Talib | Son-in-law of the Prophet ﷺ | 40 H |
| 2 | Al-Hasan ibn 'Ali | Son of 'Ali | 50 H |
| 3 | Al-Husayn ibn 'Ali | Son of 'Ali | 61 H |
| 4 | 'Ali Zayn al-'Abidin | Son of Husayn | 94 H |
| 5 | Muhammad al-Baqir | Son of Zayn al-'Abidin | 114 H |
| 6 | Ja'far as-Sadiq | Son of al-Baqir | 148 H |
| 7 | Musa al-Kazim | Son of Ja'far | 183 H |
| 8 | 'Ali ar-Rida | Son of Musa | 203 H |
| 9 | Muhammad al-Jawad | Son of ar-Rida | 220 H |
| 10 | 'Ali al-Hadi | Son of al-Jawad | 254 H |
| 11 | Al-Hasan al-'Askari | Son of al-Hadi | 260 H |
| 12 | Muhammad al-Mahdi | Son of al-'Askari | **Occluded** (according to them) |
...
| Imamite Belief | What They Claim |
|----------------|-----------------|
| The Imamate is a **pillar of faith** | Greater than prayer and zakat |
| The Imamate by **text** (nass) | The Prophet ﷺ explicitly designated 'Ali |
| The Imams are **infallible** | They never err, like the prophets |
| The Imams have **knowledge of the unseen** | They know what was and what will be |
...
**Answer**:
| Subject | Sunnis | Shi'ite Imamiyyah |
|---------|--------|-------------------|
| The Companions | All honored | The majority excommunicated |
| The Imamate | Not a pillar | Pillar of faith |
| Abu Bakr, 'Umar | Best after the Prophet ﷺ | Cursed usurpers |
| 'A'ishah | Mother of the Believers | Slandered |
| The Quran | Preserved | Some say it is falsified |
...
| Branch | Position Toward the Sahaba | Doctrinal Excesses | Ruling |
|--------|---------------------------|-------------------|--------|
| **Zaydiyyah** | Accept Abu Bakr and 'Umar | Few excesses | Closest to the Sunnah |
| **Imamiyyah** | Excommunicate the majority | Imamate, Taqiyyah, Raj'ah | Grave innovators |
| **Isma'iliyyah** | Reject the Companions | Esotericism, Batiniyyah | Dangerous sects |
| **Ghulat** (Nusayris, Druze) | Total rejection | Deification of 'Ali | **Disbelievers** by consensus |
