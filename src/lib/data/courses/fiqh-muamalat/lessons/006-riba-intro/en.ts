export const contentEn = `# Usury (Riba) — Definition and Prohibition
...
1. A bank deposit at 5% annual interest (guaranteed but forbidden)
2. A partnership in a business project (risky but permissible)
