export const contentFr = `# L'Usure — Définition et Interdiction

## Définition de l'Usure (Riba)

### Étymologie
Riba : l'augmentation, de raba yarbu qui signifie augmenter et croître.
> Allah تعالى dit : {Et tu vois la terre desséchée, puis quand Nous y faisons descendre de l'eau, elle s'agite et gonfle} [Al-Hajj : 5]

### Terminologie
> Une augmentation spécifique dans certains types de biens, ou une augmentation de la dette en contrepartie du délai.
...
> Allah تعالى dit : {Ô vous qui croyez ! Ne mangez pas l'usure doublée et redoublée, et craignez Allah afin que vous réussissiez} [Âl 'Imran : 130]

### Deuxième Verset : L'Annulation de l'Usure
> Allah تعالى dit : {Allah anéantit l'usure et fait fructifier les aumônes, et Allah n'aime pas tout mécréant pécheur} [Al-Baqarah : 276]

### Troisième Verset : L'Interdiction Explicite
> Allah تعالى dit : {Et Allah a permis le commerce et a interdit l'usure} [Al-Baqarah : 275]

### Quatrième Verset : La Déclaration de Guerre
> Allah تعالى dit : {Ô vous qui croyez ! Craignez Allah et renoncez à ce qui reste de l'usure, si vous êtes croyants. Si vous ne le faites pas, alors préparez-vous à une guerre de la part d'Allah et de Son Messager} [Al-Baqarah : 278-279]

---

## L'Interdiction de l'Usure dans la Sunna Prophétique

### Premier Hadith : Parmi les Grands Péchés
> Le Prophète ﷺ a dit : "Évitez les sept péchés destructeurs... et manger l'usure..." [Rapporté par al-Bukhari et Muslim]

### Deuxième Hadith : La Malédiction du Consommateur d'Usure
...
- L'usure est un profit sans travail ni risque
- Injustice envers l'emprunteur dans le besoin

### 2. Nuire aux Pauvres
- Exploitation du besoin des nécessiteux
- Accumulation de richesse chez les riches

### 3. Paralyser le Travail et le Commerce
- Celui qui obtient le profit par l'usure ne travaille pas
- Décourage la production

### 4. Couper la Bienfaisance entre les Gens
- Le prêt gratuit est parmi les meilleures bonnes actions
- L'usure le transforme en exploitation

### 5. Corruption des Relations Sociales
- Crée l'inimitié entre les gens
- Fait perdre la miséricorde et la coopération

---

## Le Doute des Gens de l'Ignorance et sa Réponse

### Le Doute
> Ils ont dit : {Le commerce est semblable à l'usure} [Al-Baqarah : 275]

Ils ont prétendu que l'usure est comme le commerce dans l'augmentation et le profit.

### La Réponse Coranique
> {Et Allah a permis le commerce et a interdit l'usure} [Al-Baqarah : 275]

**La différence entre le commerce et l'usure :**

| Commerce | Usure |
|----------|-------|
| Profit contre marchandise ou service | Augmentation contre argent seulement |
...
## Le Danger de l'Usure sur l'Individu et la Société

### Sur l'Individu

1. **L'effacement de la bénédiction**
   > {Allah anéantit l'usure} [Al-Baqarah : 276]

2. **La guerre d'Allah**
   > {alors préparez-vous à une guerre de la part d'Allah et de Son Messager} [Al-Baqarah : 279]

3. **Se lever comme le possédé**
   > {Ceux qui mangent l'usure ne se lèvent que comme se lève celui que le toucher de Satan a frappé} [Al-Baqarah : 275]
...
2. **L'écart entre les classes**
   - La concentration de la richesse
   - L'augmentation de la pauvreté

3. **La corruption des relations**
   - L'inimitié et la haine
...
1. L'arrêt immédiat de l'usure
2. Le regret de ce qui est passé
3. La résolution de ne pas revenir

### Ce que Fait le Repentant

> Allah تعالى dit : {Et si vous vous repentez, vous avez droit à vos capitaux. Vous ne lésez personne et vous n'êtes pas lésés} [Al-Baqarah : 279]

- Il prend seulement son capital
- Il donne en aumône l'augmentation usuraire
- Il ne la réclame pas à l'emprunteur
...
### 1. Le Prêt Gratuit
> Allah تعالى dit : {Qui est celui qui fait à Allah un bon prêt, et Il le lui multiplie plusieurs fois ?} [Al-Baqarah : 245]

### 2. Le Partenariat et la Commandite
- Partage du profit et de la perte
- Encourage le travail et la production

### 3. La Vente à Tempérament
- Vente à un prix plus élevé avec délai
- Permis car c'est le prix d'une marchandise
