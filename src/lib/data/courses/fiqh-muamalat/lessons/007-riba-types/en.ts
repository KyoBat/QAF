export const contentEn = `# Types of Usury (Ribâ)
...
│          │                 │                 │                      │
│          ▼                 ▼                 ▼                      │
│     Ribâ al-Fadl     Ribâ an-Nasî'a     Ribâ of Loans               │
│     (Surplus)         (Delay)          (Jahiliyyah)                 │
│          │                 │                 │                      │
│    ┌─────┴─────┐     ┌─────┴─────┐     ┌─────┴─────┐               │
│    │           │     │           │     │           │               │
│    ▼           ▼     ▼           ▼     ▼           ▼               │
│   Gold       Wheat  Delayed   Delayed  Loan      Accumu-            │
│   for        for    deli-     recep-   with      lated              │
│   gold+more  wheat  very      tion     surplus   debt               │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
...
\`\`\`
┌─────────────────────────────────────────────────────────────────────┐
│       Two Mandatory Conditions for Selling a Usurious Item          │
│                       Against Its Kind                               │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│     ┌────────────────────────┐    ┌────────────────────────┐        │
...
│     │    ⚖️ Equality         │    │    🤝 Taking           │        │
│     │                        │    │       Possession       │        │
│     │  Parity in measure     │    │  Reception in the      │        │
│     │    or weight           │    │  session (hand to hand)│        │
│     │                        │    │                        │        │
│     │  Gold = Gold           │    │  I give you and I      │        │
│     │  Wheat = Wheat         │    │  receive simultaneously│        │
│     │                        │    │                        │        │
│     └────────────────────────┘    └────────────────────────┘        │
│                                                                      │
│  ❌ Violation of equality = Ribâ al-Fadl                            │
│  ❌ Violation of taking possession = Ribâ an-Nasî'a                 │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│   First Division: Delay in the same kind                            │
│   ──────────────────────────────────────                             │
│   • Selling gold for gold with deferred delivery                    │
│   • Selling wheat for wheat to be delivered after a month           │
│   • Ruling: Forbidden by definitive consensus                       │
│                                                                      │
│   Second Division: Delay between two kinds of same cause            │
│   ──────────────────────────────────────                             │
│   • Selling gold for silver on credit                               │
│   • Selling wheat for barley on credit                              │
│   • Ruling: Forbidden because the cause is identical                │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
...
\`\`\`
┌─────────────────────────────────────────────────────────────────────┐
│       ⚠️ Why is Loan Usury the Most Severe?                         │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│  ① It is mentioned explicitly in the Quran                          │
│     {Prepare for war from Allah and His Messenger}                  │
│                                                                      │
│  ② It is the Jahiliyyah usury abolished by Islam                    │
│     "The usury of Jahiliyyah is abolished"                          │
│                                                                      │
│  ③ It explicitly exploits the needy                                 │
│     The creditor profits guaranteed, the debtor drowns              │
│                                                                      │
│  ④ The debt multiplies frighteningly                                │
│     1000 → 1500 → 2000 → 3000 → ...                                 │
│                                                                      │
│  ⑤ It leads to enslaving the debtor                                 │
│     In Jahiliyyah, he was sold to pay his debt                      │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
...
\`\`\`
┌─────────────────────────────────────────────────────────────────────┐
│              💰 The Six Textual Usurious Categories                  │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│         Currencies                         Foodstuffs               │
│         ──────────                         ──────────               │
│                                                                      │
│      ┌─────┐    ┌─────┐         ┌─────┐  ┌─────┐  ┌─────┐  ┌─────┐  │
│      │  ①  │    │  ②  │         │  ③  │  │  ④  │  │  ⑤  │  │  ⑥  │  │
...
│      └─────┘    └─────┘         └─────┘  └─────┘  └─────┘  └─────┘  │
│                                                                      │
│      Cause: Monetary value      Cause: Food + measure/weight        │
│      (thanamiyyah)              (basic sustenance)                  │
│                                                                      │
│   📌 By analogy:                📌 By analogy:                       │
│   • Paper currencies            • Rice and corn                     │
│   • Cryptocurrencies?           • Meats and fish                    │
│                                 • Grains and legumes                │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
...
| School | Cause for Gold & Silver | Cause for Foodstuffs |
|--------|------------------------|----------------------|
| **Hanafi** | Weight with identity of kind | Measure or weight with kind |
| **Maliki** | Monetary value | Storable staple food |
| **Shafi'i** | Monetary value | Being food (edible) |
| **Hanbali** | Weight or monetary value | Measure/weight with food |
...
\`\`\`
┌─────────────────────────────────────────────────────────────────────┐
│         📐 The Three Rules for Selling Usurious Categories           │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│  ═══════════════════════════════════════════════════════════════    │
│  Rule ①: Kind for kind (gold/gold, wheat/wheat)                     │
│  ═══════════════════════════════════════════════════════════════    │
│                                                                      │
│     Equality ──► Mandatory                                          │
│     Taking possession ──► Mandatory                                 │
│                                                                      │
│  ═══════════════════════════════════════════════════════════════    │
│  Rule ②: Two kinds with same cause (gold/silver, wheat/barley)      │
│  ═══════════════════════════════════════════════════════════════    │
│                                                                      │
│     Surplus ──► Permitted                                           │
│     Taking possession ──► Mandatory                                 │
│                                                                      │
│  ═══════════════════════════════════════════════════════════════    │
│  Rule ③: Two kinds with different causes (gold/wheat, silver/dates) │
│  ═══════════════════════════════════════════════════════════════    │
│                                                                      │
│     Surplus ──► Permitted                                           │
│     Delay ──► Permitted                                             │
...
| Sale | Equality | Taking Possession | Ruling |
|------|----------|-------------------|--------|
| Gold for gold | Mandatory | Mandatory | Permitted with both conditions |
| Gold for silver | Surplus allowed | Mandatory | Permitted hand to hand |
| Wheat for wheat | Mandatory | Mandatory | Permitted with both conditions |
| Wheat for barley | Surplus allowed | Mandatory | Permitted hand to hand |
| Gold for wheat | Surplus allowed | Delay allowed | Permitted absolutely |
| Riyal for dollar | Surplus allowed | Mandatory | Permitted hand to hand |
...
\`\`\`
┌─────────────────────────────────────────────────────────────────────┐
│              ❌ The Most Common Usurious Tricks                      │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│  ① The 'Înah Sale                                                   │
│     • I sell to you on credit then buy from you cash for less      │
│     • Objective: Get cash with increase                             │
│                                                                      │
│  ② Organized Tawarruq (according to some scholars)                  │
│     • Buying merchandise from the bank on credit                    │
│     • Then selling to the same bank for cash                        │
│     • The client never saw the merchandise!                         │
│                                                                      │
│  ③ Loan with Conditioned Gift                                       │
│     • I lend you on condition you gift me...                        │
│     • Or on condition you let me stay in your house...              │
│                                                                      │
│  ④ Incorporating Interest into the Price                            │
│     • The merchandise is worth 100, but I write 120                 │
│     • And the surplus is "my profit from the sale"!                 │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
...
|---------------------|---------------------------|
| You take money and return more | You buy real merchandise |
| No merchandise in the transaction | The merchandise is the object of the contract |
| The increase = interest | The increase = price of the delay |
...
\`\`\`
┌─────────────────────────────────────────────────────────────────────┐
│              🎯 Summary: Types of Usury                              │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│  ✅ Ribâ al-Fadl = Surplus in selling kind for kind                 │
│     Solution: Equality and taking possession                        │
│                                                                      │
│  ✅ Ribâ an-Nasî'a = Delay in receiving the exchange items          │
│     Solution: Taking possession in the session                      │
│                                                                      │
│  ✅ Ribâ of Loans = Conditioned increase in the loan                │
│     Solution: Charitable loan without interest                      │
│                                                                      │
│  ✅ The six categories: gold, silver, wheat, barley, dates, salt    │
│                                                                      │
│  ✅ The three rules:                                                 │
│     • Kind for kind: equality + taking possession                   │
│     • Two kinds with same cause: taking possession only             │
│     • Two kinds with different causes: total freedom                │
│                                                                      │
│  ✅ Usurious tricks are forbidden: What matters are intentions,     │
│     not forms                                                       │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
\`\`\`
