...
\`\`\`
    ...
    ┌──────────────┼──────────────┐
    │              │              │
تحقيق التبادل   تسهيل المعيشة   تنمية الثروة
(ما عندك قد    (تلبية الحاجات   (الحث على
يحتاجه غيرك)   المختلفة)       العمل والتجارة)
    │              │              │
    └──────────────┼──────────────┘
                   │
          التعاون بين الناس
...
\`\`\`
   💬 المساومة
       │
 البائع لا يُخبر ──→ المشتري يساوم ──→ يتفقان على سعر
 بثمن الشراء
\`\`\`
...
\`\`\`
   📈 المرابحة
       │
 البائع يُخبر  ──→  يُضيف ربحاً  ──→  الثمن النهائي
 بثمن الشراء       معلوماً
   (١٠٠)           (٢٠)              (١٢٠)
\`\`\`
...
\`\`\`
      ...
      ┌────────────┼────────────┐
      │            │            │
  القولية       الفعلية      الكتابية
 (بعتُ،       (المعاطاة:    (العقود
 اشتريتُ)    التبادل       المكتوبة،
              بالفعل)      المراسلات)
\`\`\`
