export const contentEn = `# Options in Sale (Al-Khiyārāt)
...
1. The buyer did not see it before the contract
2. The rescission must be immediate
3. The item differs from the description or expectations
