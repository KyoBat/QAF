...
| Action | Statut | Note |
|--------|--------|------|
| Se baigner pour se rafraîchir | ✅ Permis | Éviter d'avaler de l'eau |
...
|-----------|--------|-----------|
| Goûter pour vérifier le sel | ✅ Permis | Sans avaler |
...
|--------|----------|-----------|
| Embrasser | Personne maître d'elle-même | ✅ Permis |
| Embrasser | Jeune craignant de céder | ⚠️ Makruh |
