/**
 * Seerah - Lesson 001: Arabia Before Islam
 * English Content
 */

export const content = `# 🏜️ Arabia Before Islam — The Land of Prophecy
...
1. **The Kaaba** — The sanctuary where all were safe
2. **The Sacred Months** — Four months when wars ceased
3. **Alliances** — Treaties with tribes along the routes
...
1. **Language** — Eloquence and oratory
2. **Poetry** — The dîwân of the Arabs
3. **Genealogies** — Preservation of lineages
...
1. **Why** did Allah choose to send the Seal of the Prophets in this place and time?

2. **How** would the message of Islam transform everything we've seen of the Jâhiliyyah?

3. **What** similarities do you see between today's world and the world before the Revelation?
