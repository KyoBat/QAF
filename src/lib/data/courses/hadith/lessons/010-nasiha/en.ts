/**
 * Sciences du Hadith - Lesson 010: Religion is Sincere Advice
 * The Religion is Naṣīḥa — Sincere Counsel
 * English content - Academic methodology with verified references
 */

export const content = `# 📜 The Religion is Sincere Advice — الدِّينُ النَّصِيحَةُ
