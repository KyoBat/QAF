/**
 * Sciences of Hadith - Lesson 004: ترك ما لا يعني
 * Leave What Does Not Concern You - The Excellence of Islam
 * English Content - Scholarly and Qualitative Approach
 */

export const content = `# 📜 من حسن إسلام المرء تركه ما لا يعنيه — Leave What Does Not Concern You
...
1. **Quality criterion** : It establishes a measurable indicator of the quality of one's Islam
2. **Time protection** : Time is the most precious resource
3. **Heart purification** : Keeps away from backbiting, rumors, and conflicts
4. **Social peace** : Preserves relationships and avoids unnecessary tensions
5. **Spiritual focus** : Allows concentration on one's own worship
