/**
 * Sciences du Hadith - Lesson 007: لا تغضب
 * Do Not Get Angry - Self-Control and Anger Management
 * English Content - Scholarly Approach and Quality References
 */

export const content = `# 📜 لَا تَغْضَبْ — Do Not Get Angry
