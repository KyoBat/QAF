/**
 * Lesson — The Expedition of Tabuk
 * English Version — In-depth Academic Content
 */

export const lessonTabukEn = {
  title: 'The Expedition of Tabuk: The Test of Sincerity',
  content: `# ⚔️ The Expedition of Tabuk — غَزْوَةُ تَبُوك
...
| Empire | Leader | Religion | Army | Attitude |
|--------|--------|----------|------|----------|
| **Byzantine** | Heraclius | Christian | 200,000+ | Growing hostility |
| **Ghassanids** | Jabalah | Arab Christians | 40,000 | Vassals of Byzantium |
| **Islamic State** | Muhammad ﷺ | Islam | ~30,000 | Preemptive defense |
...
| Difficulty | Details |
|------------|---------|
| **Extreme heat** | Month of Rajab, Arabian summer (~45-50°C / 113-122°F) |
| **Immense distance** | ~700 km from Medina to Tabuk (one way) |
| **Ripe harvests** | Date season, people wanted to stay |
| **Powerful enemy** | Confronting Rome, the world superpower |
| **Lack of resources** | Few mounts, little provisions |
...
| Stage | Detail |
|-------|--------|
| **Departure** | Rajab 9 AH (~October 630 CE) |
| **Forces** | ~30,000 fighters (the largest army) |
| **Duration** | ~20 days of marching |
| **Distance** | ~700 km |
| **Difficulties** | Thirst, hunger, heat, morale |
...
|--------|---------|
| **Duration** | 50 days |
| **Prohibitions** | No one spoke to them or greeted them |
| **Even spouses** | Ordered to separate from them (without divorce) |
| **Maximum trial** | Ka'b received a letter from the Ghassanid king inviting him to join — he burned it |
...
| Category | Behavior | Consequence |
|----------|----------|-------------|
| **Hypocrites** | False excuses | Exposed and humiliated |
| **Ka'b and companions** | Painful truth | Divine pardon and eternal honor |
| **Abu Bakr** | Total giving | "I will never surpass him" ('Umar) |
...
| Aspect | Before Tabuk | After Tabuk |
|--------|--------------|-------------|
| **Northern border** | Byzantine threat | Stabilized by treaties |
| **Hypocrites** | Hidden | Exposed and marginalized |
| **Ummah unity** | Tested | Reinforced |
| **International prestige** | Regional | Rome retreats before Islam |
| **Believers' sincerity** | Variable | Tested and confirmed |
