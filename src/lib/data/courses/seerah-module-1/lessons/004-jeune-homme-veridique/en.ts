/**
 * Seerah - Lesson 004: The Truthful Young Man
 * English Content — Revised version (without overlap with lesson 005)
 */

export const content = `# 💎 The Truthful Young Man — A Reputation Before Prophethood
...
1. **Why** did people trust Muhammad ﷺ despite his poverty?

2. **How** did his reputation contribute to the success of his later mission?

3. **What** can we learn from his business ethics today?

4. **Why** did the Prophet ﷺ endorse Hilf al-Fudul after Islam?

5. **How** can we apply the principles of Hilf al-Fudul in our societies today?
