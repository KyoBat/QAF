...
|----------|-------------|
| **Qamīṣ (chemise)** | Sa pièce préférée, jusqu'aux mi-tibias |
| **Izār (pagne)** | Tissu enroulé à la taille |
| **Ridā' (manteau)** | Drapé sur les épaules |
| **Burda (cape)** | Cape rayée du Yémen qu'il affectionnait |
