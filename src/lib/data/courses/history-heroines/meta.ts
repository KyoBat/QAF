/**
 * Cours: Les Femmes Héroïques de l'Islam (النساء البطلات)
 * Histoire Islamique - Histoires captivantes des femmes exemplaires
 */

import { CourseMeta } from '../types'

export const historyHeroinesMeta: CourseMeta = {
  id: 'course-017',
  slug: 'femmes-heroiques-islam',
  title: {
    fr: 'Les Femmes Héroïques de l\'Islam',
    ar: 'النساء البطلات في الإسلام',
    en: 'The Heroic Women of Islam',
  },
  description: {
  ...
  image: '/images/courses/history-heroines.svg',
  tags: ['history', 'women', 'heroines', 'sahaba', 'scholars', 'biography', 'faith', 'inspiration'],
  featured: true,
  published: true,
  resources: [],
