...
| Période | Situation |
|---------|-----------|
| **1-3 H avant Hégire** | Persécution individuelle |
...
- Les **affranchis** (statut social faible)
- Les **femmes seules** (vulnérables)
- Les **jeunes** (sans influence)
...
| Information | Détail |
|-------------|--------|
| **Nom complet** | Sumayyah bint Khayyāṭ (ou bint Khubbāṭ) |
| **Statut** | Ancienne esclave, affranchie |
| **Mari** | Yāsir ibn 'Āmir (du Yémen) |
| **Fils** | 'Ammār ibn Yāsir |
...
- **Sumayyah** : Esclave de Abū Ḥudhayfa ibn al-Mughīra, affranchie après son mariage
- **'Ammār** : Né de leur union, sans protection tribale

> **🏠 LA FAMILLE YĀSIR**
> 
> Yāsir (père) ← Mari → Sumayyah (mère)
>           ↓
>        'Ammār (fils)
>           ↓
...
| Persécuteur | Torture infligée |
|-------------|------------------|
| **Abū Jahl** | Chef des persécutions |
...
> **📜 RÉCIT DU MARTYRE**
>
> Abū Jahl, frustré par sa résistance, lui dit : 
> « *Tu n'as embrassé l'Islam que par amour pour Muḥammad !* »
>
> Elle répondit fermement, refusant de blasphémer.
>
> Fou de rage, **Abū Jahl la transperça de sa lance** au niveau des parties intimes.
>
> Elle mourut sur le coup — **la première martyre de l'Islam**.

| Détail | Information |
|--------|-------------|
| **Date** | Vers la 7ᵉ année avant l'Hégire |
| **Âge** | Âgée (certains disent 90 ans) |
| **Meurtrier** | Abū Jahl ('Amr ibn Hishām) |
...
| Membre | Destin |
|--------|--------|
| **Sumayyah** | Première martyre, tuée par Abū Jahl |
| **Yāsir** | Martyr, mort sous la torture |
...
|-------------|--------|
| **Statut** | Esclave |
| **Maîtres** | Banū Zuhra (ou Banū Taym) |
| **Persécuteur** | Al-Aswad ibn 'Abd Yaghūth |
...
| **Origine** | Romaine (Rūm) |
| **Statut** | Esclave |
| **Persécuteur** | Abū Jahl |
| **Torture** | Battue jusqu'à perdre la vue |
...
| Information | Détail |
|-------------|--------|
| **Statut** | Esclaves (mère et fille) |
| **Maîtresse** | Une femme de Banū 'Abd al-Dār |
| **Torture** | Contraintes à moudre le grain sans cesse |
| **Libérateur** | Abū Bakr al-Ṣiddīq |
...
|-------------|--------|
| **Statut** | Esclave |
| **Persécuteur** | 'Umar ibn al-Khaṭṭāb (avant l'Islam) |
| **Torture** | Battue par 'Umar lui-même |
| **Libérateur** | Abū Bakr al-Ṣiddīq |
...
| Information | Détail |
|-------------|--------|
| **Statut** | Femme libre de Quraysh (Banū 'Āmir) |
| **Situation** | Convertie secrètement, prêchait aux femmes |
| **Torture** | Découverte, privée d'eau sous le soleil pendant 3 jours |
| **Miracle** | Une outre d'eau descendit du ciel |
| **Destin** | Survécut, émigra à Médine |
...
| Esclave affranchi(e) | Statut |
|---------------------|--------|
| **Bilāl ibn Rabāḥ** | Esclave abyssin, muezzin |
| **'Āmir ibn Fuhayra** | Esclave, combattit à Badr |
| **Umm 'Ubays** | Esclave torturée |
| **Zinīra al-Rūmiyya** | Esclave romaine aveuglée |
| **Al-Nahdiyya et sa fille** | Esclaves mère-fille |
...
Ces versets furent révélés à propos d'**Abū Bakr** et de son affranchissement des esclaves.
...
| Leçon | Application |
|-------|-------------|
| Sumayyah était esclave | La foi élève au-dessus de la naissance |
...
| Point | Signification |
|-------|---------------|
| Sumayyah = 1ère martyre | Avant tout homme |
...
|-------------------|-------|
| Dépensa sa fortune | L'argent au service de la foi |
| Affranchit les faibles | Protéger les opprimés |
| Sans chercher la gloire | Sincérité (ikhlāṣ) |
...
| **Famille Yāsir** | Modèle de la famille croyante |
| **Les affranchies** | Fondatrices de la Umma |
...
| # | Point |
|---|-------|
| 1 | **Sumayyah** = Première martyre de l'Islam (avant tout homme) |
| 2 | **Tuée par Abū Jahl** d'un coup de lance |
| 3 | **Famille Yāsir** = Les trois torturés, le Prophète ﷺ leur promit le Paradis |
| 4 | **Abū Bakr** = Affranchit 7+ esclaves torturés avec sa fortune |
| 5 | **Versets révélés** = Sourate Al-Layl (92) sur Abū Bakr |
