...
| Titre | Signification |
|-------|---------------|
| **الصِّدِّيقة بنت الصِّدِّيق** | La Véridique fille du Véridique |
| **أم المؤمنين** | Mère des Croyants |
| **الحُمَيْرَاء** | La Blanche-Rosée (surnom affectueux du Prophète ﷺ) |
| **حبيبة رسول الله** | Bien-aimée du Messager d'Allah |
| **المُبرَّأة من فوق سبع سماوات** | Innocentée depuis les sept cieux |
...
| Information | Détails |
|-------------|---------|
| **Père** | Abū Bakr al-Ṣiddīq — Premier calife, meilleur des hommes après les prophètes |
| **Mère** | Umm Rūmān bint 'Āmir |
| **Sœur** | Asmā' bint Abī Bakr (« Dhāt al-Niṭāqayn ») |
...
| Détail | Information |
|--------|-------------|
| **Mariage** | À La Mecque, après la mort de Khadīja |
| **Consommation** | À Médine, après l'Hégire |
| **Statut unique** | Seule épouse vierge du Prophète ﷺ |
| **Durée** | 9 ans de vie conjugale |
...
| Signe | Description |
|-------|-------------|
| **Boire au même endroit** | Buvait où elle avait posé ses lèvres |
| **Manger ensemble** | Mordait où elle avait mordu |
| **Courses** | Faisait des courses à pied avec elle |
...
| Rang | Compagnon | Nombre de hadiths |
|------|-----------|-------------------|
| 1 | Abū Hurayra | 5 374 |
...
| Domaine | Excellence |
|---------|------------|
| **Fiqh** | Référence absolue, corrigeait les grands Compagnons |
| **Hadith** | 2 210 hadiths transmis |
| **Tafsīr** | Connaissance des circonstances de révélation |
| **Médecine** | Experte en remèdes prophétiques |
| **Poésie** | Mémorisait des milliers de vers |
...
| Compagnon corrigé | Sujet |
|-------------------|-------|
| 'Umar ibn al-Khaṭṭāb | Châtiment de la tombe |
| Ibn 'Umar | Le mort puni pour les pleurs |
...
- Pleurait abondamment par crainte d'Allah
...
| Aspect | Détail |
|--------|--------|
| **Motivation** | Justice pour 'Uthmān |
| **Adversaire** | 'Alī ibn Abī Ṭālib |
...
| Élève | Contribution |
|-------|--------------|
| **'Urwa ibn al-Zubayr** | Son neveu, grand juriste |
| **Al-Qāsim ibn Muḥammad** | Son neveu, un des 7 fuqahā' de Médine |
| **'Amra bint 'Abd al-Raḥmān** | Grande savante, transmit son fiqh |
| **Al-Aswad ibn Yazīd** | Tābi'ī, transmetteur prolifique |
| **Masrūq ibn al-Ajda'** | Tābi'ī, grand faqīh |
...
| # | Point |
|---|-------|
| 1 | **4ᵉ plus grand transmetteur** de hadiths (2 210) |
| 2 | **Innocentée par le Coran** — 10 versets dans Al-Nūr |
| 3 | **La personne la plus aimée** du Prophète ﷺ |
| 4 | **Référence suprême** — Les Compagnons la consultaient |
| 5 | Vécut **47 ans** après le Prophète ﷺ, enseignant sans relâche |
