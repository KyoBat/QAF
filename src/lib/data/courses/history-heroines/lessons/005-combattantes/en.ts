...
| Information | Detail |
|-------------|--------|
| **Name** | Nusayba bint Ka'b ibn 'Amr al-Anṣāriyya |
| **Kunya** | Umm 'Umāra (أم عمارة) |
| **Tribe** | Al-Khazraj (Anṣār) |
| **Conversion** | Second Pledge of Aqaba |
...
| Information | Detail |
|-------------|--------|
| **Name** | Rumayṣā' (or Sahl) bint Milḥān |
| **Kunya** | Umm Sulaym |
...
| Information | Detail |
|-------------|--------|
| **Name** | Khawla bint al-Azwar (or Dhirār) |
| **Brother** | Ḍirār ibn al-Azwar (great warrior) |
