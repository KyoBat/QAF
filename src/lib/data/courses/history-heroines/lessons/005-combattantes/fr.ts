...
| Rôle | Exemples |
|------|----------|
| **Soins aux blessés** | Majorité des femmes |
| **Approvisionnement en eau** | Pendant le combat |
| **Transport des martyrs** | Après la bataille |
| **Combat direct** | Nusayba, Khawla, Umm Sulaym |
| **Commandement** | Rare mais existant |
...
| Information | Détail |
|-------------|--------|
| **Nom** | Nusayba bint Ka'b ibn 'Amr al-Anṣāriyya |
| **Kunya** | Umm 'Umāra (أم عمارة) |
| **Tribu** | Al-Khazraj (Anṣār) |
| **Conversion** | Deuxième Allégeance d'Aqaba |
...
| Bataille | Détail |
|----------|--------|
| **Date** | 3ᵉ année de l'Hégire (625 CE) |
| **Lieu** | Mont Uhud, près de Médine |
...
|----------|-------------|
| **Coup d'épée 1** | Épaule (profonde) |
| **Coup d'épée 2** | Cou |
| **Autres blessures** | 12 blessures au total |
...
> Nusayba s'interposa et reçut le coup à sa place.
...
|----------|---------------|
| **Uhud** (625) | Combat héroïque |
| **Al-Ḥudaybiya** (628) | Présente au traité |
| **Khaybar** (628) | Participa au siège |
...
| Détail | Information |
|--------|-------------|
| **Âge de Nusayba** | Plus de 60 ans |
| **Pertes** | Une main coupée |
| **Blessures** | 11 blessures |
| **Résultat** | Musaylima tué (elle contribua à sa mort) |
...
| Information | Détail |
|-------------|--------|
| **Nom** | Rumayṣā' (ou Sahl) bint Milḥān |
| **Kunya** | Umm Sulaym |
| **Mari 1** | Mālik ibn Naḍr (père d'Anas) |
...
| Information | Détail |
|-------------|--------|
| **Nom** | Khawla bint al-Azwar (ou Dhirār) |
| **Frère** | Ḍirār ibn al-Azwar (grand guerrier) |
...
> **📜 RÉCIT HÉROÏQUE**
>
> Khawla se déguisa en cavalier noir, attaqua les lignes ennemies, et combattit si férocement que les musulmans la prirent pour Khālid ibn al-Walīd.
>
> Quand on lui demanda son identité, elle ôta son voile : une femme !
>
...
- Elle déchira sa **ceinture** en deux pour attacher la nourriture
- Elle mentit à Abū Jahl sur la destination de son père
...
- Elle lui dit : « *Meurs libre plutôt que de te rendre !* »
...
| Information | Détail |
|-------------|--------|
| **Lien** | Tante du Prophète ﷺ |
| **Exploit** | Tua un espion juif à la bataille du Fossé |
...
| Information | Détail |
|-------------|--------|
| **Lien** | Tante maternelle d'Anas ibn Mālik |
| **Prophétie** | Le Prophète ﷺ annonça qu'elle participerait à une expédition maritime |
...
| Exemple | Leçon |
|---------|-------|
| Nusayba à Uhud | Les femmes peuvent exceller au combat |
...
|----------|-------------|
| Obligation de défense | Quand la communauté est attaquée |
...
| Aspect | Réalité |
|--------|---------|
| Ces femmes étaient aussi | Mères, épouses, éducatrices |
| Le combat était | L'exception, pas la règle |
| Le courage s'exprime | De multiples façons |
...
| # | Point |
|---|-------|
| 1 | **Nusayba bint Ka'b** = Défendit le Prophète ﷺ à Uhud, 12 blessures |
| 2 | **Umm Sulaym** = Portait un poignard à Ḥunayn, le Prophète ﷺ rit |
| 3 | **Khawla bint al-Azwar** = Cavalière légendaire des conquêtes |
| 4 | **Asmā' Dhāt al-Niṭāqayn** = Héroïne de l'Hégire |
| 5 | **Le combat** = Exception permise pour défendre l'Islam |
