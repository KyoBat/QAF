...
|---------|--------------|
| **Hadith** | Milliers de narratrices (rāwiyāt) |
| **Fiqh** | Muftiyyas et juristes |
| **Tafsīr** | Commentatrices du Coran |
| **Récitation** | Enseignantes du tajwīd |
| **Médecine** | Praticiennes et sages-femmes |
| **Poésie** | Poétesses célèbres |
...
| Information | Détail |
|-------------|--------|
| **Hadiths transmis** | 2 210 hadiths |
| **Rang** | 4ᵉ narratrice la plus prolifique |
| **Élèves** | Plus de 200 |
...
| Catégorie | Exemples |
|-----------|----------|
| **Compagnons** | Abū Hurayra, Ibn 'Abbās, 'Abdullāh ibn 'Umar |
...
| Principe | Exemple |
|----------|---------|
| **Vérification** | Corrigeait les erreurs de transmission |
| **Contextualisation** | Donnait le contexte des hadiths |
| **Raisonnement** | Utilisait le qiyās (analogie) |
| **Enseignement** | Enseignait aux hommes derrière le rideau |
...
| Information | Détail |
|-------------|--------|
| **Nom** | Hind bint Abī Umayya |
| **Kunya** | Umm Salama |
| **Hadiths transmis** | 378 hadiths |
...
| Information | Détail |
|-------------|--------|
| **Père** | 'Umar ibn al-Khaṭṭāb |
| **Épouse du Prophète ﷺ** | Oui |
...
- À sa mort, il les confia à **Ḥafṣa**
- **'Uthmān** les emprunta pour établir le Muṣḥaf standard
- Les originaux restèrent chez Ḥafṣa jusqu'à sa mort

> Elle fut littéralement la **gardienne du Coran** pendant des décennies.
...
| Information | Détail |
|-------------|--------|
| **Frère célèbre** | Muḥammad ibn Sīrīn (grand interprète de rêves) |
| **Spécialité** | Coran, hadith |
| **Mémorisation** | Avait mémorisé le Coran à 12 ans |
| **Témoignage** | Son frère la consultait en tafsīr |
...
| Information | Détail |
|-------------|--------|
| **Éducatrice** | Élevée dans la maison d'Āisha |
| **Rang** | Parmi les plus grandes juristes de Médine |
| **Élève célèbre** | L'imam Mālik (citait ses avis) |
| **Spécialité** | Fiqh, hadith d'Āisha |

> L'imam Mālik rapportait d'elle et la considérait comme une autorité.
...
| Information | Détail |
|-------------|--------|
| **Grand-mère** | Asmā' bint Abī Bakr |
| **Mari** | Hishām ibn 'Urwa (petit-fils d'Āisha) |
| **Spécialité** | Hadith |
| **Témoignage** | Hishām disait avoir appris d'elle plus que de quiconque |
...
|--------|---------------|
| **2ᵉ-3ᵉ H** | Tābi'iyyāt nombreuses |
| **4ᵉ-6ᵉ H** | Essor des ijāzāt féminines |
| **7ᵉ-8ᵉ H** | Apogée (Damas, Le Caire) |
| **9ᵉ-10ᵉ H** | Continuité |
| **Moderne** | Renaissance |
...
| Information | Détail |
|-------------|--------|
| **Père** | Muḥammad ibn Aḥmad al-Samarqandī (auteur de Tuḥfat al-Fuqahā') |
| **Mari** | 'Alā' al-Dīn al-Kāsānī (auteur de Badā'i' al-Ṣanā'i') |
| **Rôle** | Corrigeait les fatwas de son mari |
| **Signature** | Les fatwas portaient les deux signatures |
...
|-------------|--------|
| **Lieu** | Damas |
| **Spécialité** | Hadith, ijāzāt |
| **Rang** | Dernier maillon de chaînes précieuses |
| **Élèves** | Al-Dhahabī, Ibn Ḥajar, Al-Sakhāwī apprirent d'elle ou de ses pairs |
...
| Concept | Définition |
|---------|------------|
| **Ijāza** | Autorisation de transmettre un texte ou un savoir |
...
|-------------|-------------|
| **Aucune fabricatrice** | Pas une seule femme accusée d'avoir forgé un hadith |
| **Fiabilité** | Les femmes étaient considérées plus fiables |
| **Ijāzāt recherchées** | Des savants voyageaient pour obtenir leurs ijāzāt |
...
| Savant | Voyage |
|--------|--------|
| **Ibn Ḥajar al-'Asqalānī** | Voyagea pour apprendre de muḥaddithāt |
| **Al-Sakhāwī** | Documenta des centaines de savantes |
| **Ibn al-Ṣalāḥ** | Avait des ijāzāt de femmes |
...
|--------------|-------------|
| **Transmission** | Milliers de femmes dans les isnāds |
...
| Contribution | Description |
|--------------|-------------|
| **Fatwas** | Certaines émettaient des avis juridiques |
...
| Contribution | Description |
|--------------|-------------|
| **Récitation** | Chaînes de récitation passant par des femmes |
| **Enseignement** | Écoles coraniques féminines |
| **Mémorisation** | Ḥāfiẓāt nombreuses |
...
|----------|-------------|
| Le Prophète ﷺ encouragea | 'Āisha à enseigner aux hommes |
...
|--------|-------------------|
| **Instruction religieuse** | Obligation pour les femmes |
...
| Aspect | Équilibre |
|--------|-----------|
| **Vie familiale** | Ces savantes étaient mères et épouses |
| **Vie intellectuelle** | Contribuaient au savoir |
| **Respect du cadre** | Enseignaient avec pudeur (voile, rideau) |
